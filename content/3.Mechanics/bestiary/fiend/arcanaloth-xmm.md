...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+9|noform|noparens|text(+9), reach 5\
      ...
      \ the Soul Tome. While trapped there, the target has the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated)\
      ...
      \ to the tome and can escape only if the tome is reduced to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)."
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Arcanaloth.webp"
```
^statblock
