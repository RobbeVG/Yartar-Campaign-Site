...
"traits":
  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
    ...
    "name": "Inscrutable"
  - "desc": "The sphinx has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
"actions":
  - "desc": "The sphinx makes three Claw attacks. It can replace one attack with a\
      \ use of [Curse](3.Mechanics/rules/variant-rules/curses-xphb.md) of the Riddle."
    "name": "Multiattack"
  ...
  - "desc": "*Intelligence Saving Throw:* DC 15, one creature the sphinx can see within\
      ...
      \ a riddle. The cursed target has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md)\
      \ on ability checks and attack rolls. In addition, if it takes the [Magic](3.Mechanics/rules/actions.md#Magic)\
      \ action, it must succeed on a DC 15 Intelligence saving throw or that action\
      \ is wasted. The cursed target can take a [Study](3.Mechanics/rules/actions.md#Study)\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Identify](3.Mechanics/spells/identify-xphb.md),\
      ...
      \ each:** [Locate Object](3.Mechanics/spells/locate-object-xphb.md), [Remove\
      \ Curse](3.Mechanics/spells/remove-curse-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
