...
You are immune to the [Poisoned](conditions.md#Poisoned) condition, and you have [Resistance](3%20Mechanics/rules/variant-rules/resistance-xphb.md) to a damage type associated with your current land choice in the Circle Spells feature, as shown in the Nature's Ward table.
...
As a [Magic](actions.md#Magic) action, you can expend a use of your Wild Shape and cause spectral trees and vines to appear in a 15-foot [Cube](cube-area-of-effect-xphb.md) on the ground within 120 feet of yourself. They last there for 1 minute or until you have the [Incapacitated](conditions.md#Incapacitated) condition or die. You and your allies have [Half Cover](3%20Mechanics/rules/variant-rules/cover-xphb.md) while in that area, and your allies gain the current [Resistance](3%20Mechanics/rules/variant-rules/resistance-xphb.md) of your Nature's Ward while there.
