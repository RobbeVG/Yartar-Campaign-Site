...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Deer.webp#right)
...
***Agile.*** The deer doesn't provoke an [Opportunity Attack](3.Mechanics/rules/actions.md#Opportunity%20Attack) when it moves out of an enemy's reach.

## Actions

***Ram.*** *Melee Attack Roll:* `dice:1d20+2|noform|noparens|text(+2)`, reach 5 ft. *Hit:* `dice:1d4|noform|noparens|avg|text(2)` (`1d4`) Bludgeoning damage.
```
^statblock
