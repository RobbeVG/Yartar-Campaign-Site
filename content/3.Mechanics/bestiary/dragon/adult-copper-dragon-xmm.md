...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 4 version), [Minor Illusion](3.Mechanics/spells/minor-illusion-xphb.md),\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 17, one creature the dragon can see within\
      ...
      \ subtracts the number rolled from the [D20 Test](3.Mechanics/rules/variant-rules/d20-test-xphb.md).\
