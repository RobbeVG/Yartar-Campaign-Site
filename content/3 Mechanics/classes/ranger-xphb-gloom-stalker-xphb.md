...
**Ambusher's Leap.** At the start of your first turn of each combat, your [Speed](speed-xphb.md) increases by 10 feet until the end of that turn.
...
**Initiative Bonus.** When you roll [Initiative](initiative-xphb.md), you can add your Wisdom modifier to the roll.
...
You are also adept at evading creatures that rely on [Darkvision](senses.md#Darkvision). While entirely in [Darkness](3%20Mechanics/rules/variant-rules/darkness-xphb.md), you have the [Invisible](conditions.md#Invisible) condition to any creature that relies on [Darkvision](senses.md#Darkvision) to see you in that [Darkness](3%20Mechanics/rules/variant-rules/darkness-xphb.md).
...
**Mass Fear.** The target and each creature within 10 feet of it must make a Wisdom saving throw against your spell save DC. On a failed save, a creature has the [Frightened](conditions.md#Frightened) condition until the start of your next turn.
