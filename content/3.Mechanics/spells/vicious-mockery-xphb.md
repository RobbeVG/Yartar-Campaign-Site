...
You unleash a string of insults laced with subtle enchantments at one creature you can see or hear within range. The target must succeed on a Wisdom saving throw or take `dice:1d6|noform|noparens|avg` (`1d6`) Psychic damage and have [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on the next attack roll it makes before the end of its next turn.
...
**Classes**: [Bard](3.Mechanics/lists/list-spells-classes-bard.md)
