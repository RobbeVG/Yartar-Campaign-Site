...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Shield%20Guardian.webp#right)
...
***Regeneration.*** The guardian regains 10 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) at the start of each of its turns if it has at least 1 [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md).
...
***Fist.*** *Melee Attack Roll:* `dice:1d20+7|noform|noparens|text(+7)`, reach 10 ft. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) Bludgeoning damage plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) Force damage.
