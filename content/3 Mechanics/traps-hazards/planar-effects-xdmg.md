...
The plane of "Acheron" rewards a creature for harming other creatures by imbuing it with the strength to keep fighting. While in Acheron or a region under its influence, a creature gains [Temporary Hit Points](temporary-hit-points-xphb.md) equal to half its Hit Point maximum whenever it reduces another creature to 0 Hit Points.

## Arcadian Vitality

On the plane of "Arcadia" and in regions where its influence is felt, creatures benefit from supernatural vitality, which grants them [Immunity](immunity-xphb.md) the [Frightened](conditions.md#Frightened) and [Poisoned](conditions.md#Poisoned) conditions.
