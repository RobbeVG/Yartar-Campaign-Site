...
As a [Magic](actions.md#Magic) action, you can use the weapon to cast [Message](message-xphb.md). Once this property is used, it can't be used again until the next dawn.
