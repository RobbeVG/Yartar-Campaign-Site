...
You grow claws (Slashing), fangs (Piercing), horns (Piercing), or hooves (Bludgeoning). When you use your [Unarmed Strike](unarmed-strike-xphb.md) to deal damage with that new growth, it deals `dice:1d6|noform|noparens|avg` (`1d6`) damage of the type in parentheses instead of dealing the normal damage for your [Unarmed Strike](unarmed-strike-xphb.md), and you use your spellcasting ability modifier for the attack and damage rolls rather than using Strength.
