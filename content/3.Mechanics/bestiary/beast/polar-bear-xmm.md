...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Polar%20Bear.webp#right)
...
***Rend.*** *Melee Attack Roll:* `dice:1d20+7|noform|noparens|text(+7)`, reach 5 ft. *Hit:* `dice:1d8+5|noform|noparens|avg|text(9)` (`1d8 + 5`) Slashing damage.
```
^statblock
