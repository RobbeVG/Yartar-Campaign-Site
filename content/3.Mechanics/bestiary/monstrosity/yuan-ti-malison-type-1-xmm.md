...
"actions":
  - "desc": "The yuan-ti makes two attacks, using Bite or Poison Ray in any combination,\
      \ and it can use Spellcasting to cast [Suggestion](3.Mechanics/spells/suggestion-xphb.md)\
      \ if available."
    "name": "Multiattack"
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Yuan-ti%20Malison%20%28Type%201%29.webp"
```
^statblock
