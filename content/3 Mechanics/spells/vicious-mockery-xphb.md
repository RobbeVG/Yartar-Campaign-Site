...
You unleash a string of insults laced with subtle enchantments at one creature you can see or hear within range. The target must succeed on a Wisdom saving throw or take `dice:1d6|noform|noparens|avg` (`1d6`) Psychic damage and have [Disadvantage](disadvantage-xphb.md) on the next attack roll it makes before the end of its next turn.
