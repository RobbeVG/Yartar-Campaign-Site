...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](enlarge-reduce-xphb.md) spell for `dice:1d4|noform|noparens|avg` (`1d4`) hours (no [Concentration](conditions.md#Concentration) required).
