...
**Colossus Slayer.** Your tenacity can wear down even the most resilient foes. When you hit a creature with a weapon, the weapon deals an extra `dice:1d8|noform|noparens|avg` (`1d8`) damage to the target if it's missing any of its [Hit Points](hit-points-xphb.md). You can deal this extra damage only once per turn.
...
When you take damage, you can take a [Reaction](reaction-xphb.md) to give yourself [Resistance](3%20Mechanics/rules/variant-rules/resistance-xphb.md) to that damage and any other damage of the same type until the end of the current turn.