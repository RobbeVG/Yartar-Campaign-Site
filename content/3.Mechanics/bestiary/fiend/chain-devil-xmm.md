...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+7|noform|noparens|text(+7), reach 10\
      ...
      \ condition (escape DC 14) from one of two chains, and it has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
  ...
  - "desc": "The devil conjures a fiery chain to bind a creature. *Dexterity Saving\
      ...
      \ (2d4 + 4) Fire damage, and the target has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
...
"reactions":
  - "desc": "Trigger: A creature the devil can see starts its turn within 30 feet\
      ...
      \ the triggering creature. *Failure:* The target has the [Frightened](3.Mechanics/rules/conditions.md#Frightened)\
      \ condition until the end of its turn. *Success:* The target is immune to this\
      \ devil's Unnerving Gaze for 24 hours."
    "name": "Unnerving Gaze"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Chain%20Devil.webp"
```
^statblock
