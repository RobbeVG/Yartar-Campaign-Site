...
An immobile, [Invisible](3.Mechanics/rules/conditions.md#Invisible), [Cube](3.Mechanics/rules/variant-rules/cube-area-of-effect-xphb.md)-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose.
...
This spell can't be dispelled by [Dispel Magic](3.Mechanics/spells/dispel-magic-xphb.md).

**Classes**: [Bard](3.Mechanics/lists/list-spells-classes-bard.md); [Warlock](3.Mechanics/lists/list-spells-classes-warlock.md); [Wizard (Evoker)](3.Mechanics/lists/list-spells-classes-evoker-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](3.Mechanics/lists/list-spells-classes-wizard.md)
