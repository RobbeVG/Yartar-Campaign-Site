...
The medallion has 5 charges. While wearing it, you can expend 1 charge to cast [Detect Thoughts](3.Mechanics/spells/detect-thoughts-xphb.md) (save DC 13) from it. The medallion regains `dice:1d4|noform|noparens|avg` (`1d4`) expended charges daily at dawn.
