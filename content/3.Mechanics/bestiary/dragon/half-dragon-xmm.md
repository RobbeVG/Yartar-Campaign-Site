...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+7|noform|noparens|text(+7), reach 10\
    ...
    "name": "Claw"
  - "desc": "*Dexterity Saving Throw:* DC 14, each creature in a 30-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* dice:8d6|noform|noparens|avg|text(28) (8d6) damage of the type\
      \ chosen for the Draconic Origin trait. *Success:* Half damage."
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Half-Dragon.webp"
```
^statblock
