...
You and any creature you designate when you use the shackles can take a [Utilize](3.Mechanics/rules/actions.md#Utilize) action to remove them. Once every 30 days, the bound creature can make a DC 30 Strength ([Athletics](3.Mechanics/rules/skills.md#Athletics)) check. On a successful check, the creature breaks free and destroys the shackles.
