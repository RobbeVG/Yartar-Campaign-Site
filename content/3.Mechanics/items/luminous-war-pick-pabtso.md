...
While wielding the war pick, you can use a bonus action to cast the [daylight](3.Mechanics/spells/daylight-xphb.md) spell, choosing a point on the war pick. Once you use this bonus action, it can't be used again until the next dawn.
