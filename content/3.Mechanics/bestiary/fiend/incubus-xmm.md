...
"cr": "4"
"traits":
  - "desc": "When the incubus finishes a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md),\
      \ it can shape-shift into a [Succubus](3.Mechanics/bestiary/fiend/succubus-xmm.md),\
...
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature the incubus can see within\
      \ 60 feet. *Failure:* If the target has 20 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ or fewer, it has the [Unconscious](3.Mechanics/rules/conditions.md#Unconscious)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Incubus.webp"
```
^statblock
