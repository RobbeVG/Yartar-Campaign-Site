...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Umber%20Hulk.webp#right)
...
***Tunneler.*** The umber hulk can burrow through solid rock at half its [Burrow Speed](3.Mechanics/rules/variant-rules/burrow-speed-xphb.md) and leaves a 10-foot-diameter tunnel in its wake.
...
***Confusing Gaze (Recharge 5-6).*** *Wisdom Saving Throw:* DC 14, each creature in a 30-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* The target can't take Reactions until the start of the umber hulk's next turn, and the target rolls `dice:1d8|noform|noparens|avg` (`1d8`) to determine what it does on its next turn:
