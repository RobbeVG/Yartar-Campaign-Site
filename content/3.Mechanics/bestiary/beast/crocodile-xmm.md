...
***Bite.*** *Melee Attack Roll:* `dice:1d20+4|noform|noparens|text(+4)`, reach 5 ft. *Hit:* `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) Piercing damage. If the target is a Medium or smaller creature, it has the [Grappled](3.Mechanics/rules/conditions.md#Grappled) condition (escape DC 12). While [Grappled](3.Mechanics/rules/conditions.md#Grappled), the target has the [Restrained](3.Mechanics/rules/conditions.md#Restrained) condition.
```
^statblock
