...
"actions":
  ...
  - "desc": "*Intelligence Saving Throw:* DC 15, one creature the sphinx can see within\
      ...
      \ damage, and the target is cursed with a riddle. The cursed target has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Sphinx%20of%20Secrets.webp"
```
^statblock
