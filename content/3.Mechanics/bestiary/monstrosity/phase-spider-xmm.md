...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+5|noform|noparens|text(+5), reach 5\
      ...
      \ If this damage reduces the target to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md),\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Phase%20Spider.webp"
```
^statblock
