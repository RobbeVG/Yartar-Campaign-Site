...
Wave has 3 charges and regains `dice:1d3|noform|noparens|avg` (`1d3`) expended charges daily at dawn. While you carry it, you can expend 1 charge to cast [Dominate Beast](dominate-beast-xphb.md) (save DC 20) from it on a Beast that has a [Swim Speed](swim-speed-xphb.md).
