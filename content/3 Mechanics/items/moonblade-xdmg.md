...
| 81-85 | The *Moonblade* scores a [Critical Hit](critical-hit-xphb.md) on a roll of 19 or 20 on the `dice:d20\|noform\|noparens\|avg` (`d20`). |
| 86-95 | You can take a [Bonus Action](bonus-action-xphb.md) to cause the *Moonblade* to flash brightly. Each other creature that is within 30 feet of you and not behind [Total Cover](3%20Mechanics/rules/variant-rules/cover-xphb.md) must succeed on a DC 15 Constitution saving throw or have the [Blinded](conditions.md#Blinded) condition for 1 minute. A creature repeats the save at the end of each of its turns, ending the effect on itself on a success. You can't use this property again until you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md). |
