...
If you have proficiency with a tool, add your [Proficiency Bonus](3.Mechanics/rules/variant-rules/proficiency-xphb.md) to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the check too.
...
**Tool (Gaming Set).** If you have proficiency with a tool, add your [Proficiency Bonus](3.Mechanics/rules/variant-rules/proficiency-xphb.md) to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the check too.
...
**Tool (Musical Instrument).** If you have proficiency with a tool, add your [Proficiency Bonus](3.Mechanics/rules/variant-rules/proficiency-xphb.md) to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the check too.
...
**Damage Threshold.** See the [rules glossary](3.Mechanics/rules/variant-rules/damage-threshold-xphb.md).

**Ship Repair.** Repairs to a damaged ship can be made while the vessel is berthed. Repairing 1 [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md) of damage requires 1 day and costs 20 GP for materials and labor. If the repairs are made in a location where supplies and skilled labor are abundant, such as a city shipyard, the repair time and cost are halved.
