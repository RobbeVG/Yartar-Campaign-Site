...
If you have Blindsight, you can see within a specific range without relying on physical sight. Within that range, you can see anything that isn't behind [Total Cover](3%20Mechanics/rules/variant-rules/cover-xphb.md) even if you have the [Blinded](conditions.md#Blinded) condition or are in [Darkness](3%20Mechanics/rules/variant-rules/darkness-xphb.md). Moreover, in that range, you can see something that has the [Invisible](conditions.md#Invisible) condition.

## Darkvision
_Source: Player's Handbook (2024) p. 365. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>_

If you have Darkvision, you can see in [Dim Light](dim-light-xphb.md) within a specified range as if it were [Bright Light](bright-light-xphb.md) and in [Darkness](3%20Mechanics/rules/variant-rules/darkness-xphb.md) within that range as if it were [Dim Light](dim-light-xphb.md). You discern colors in that [Darkness](3%20Mechanics/rules/variant-rules/darkness-xphb.md) only as shades of gray.
...
- **Darkness.** You can see in normal and magical [Darkness](3%20Mechanics/rules/variant-rules/darkness-xphb.md).  
