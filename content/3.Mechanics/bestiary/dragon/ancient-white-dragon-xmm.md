...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 22, each creature in a 90-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* dice:14d8|noform|noparens|avg|text(63) (14d8) Cold damage.\
      \ *Success:* Half damage."
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 30-foot-radius\
      ...
      \ on a point the dragon can see within 120 feet. *Failure:* dice:4d6|noform|noparens|avg|text(14)\
      \ (4d6) Cold damage, and the target's [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Ancient%20White%20Dragon.webp"
```
^statblock
