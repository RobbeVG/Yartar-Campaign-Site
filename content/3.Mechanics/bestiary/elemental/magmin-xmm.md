...
"traits":
  - "desc": "The magmin explodes when it dies. *Dexterity Saving Throw:* DC 11, each\
      \ creature in a 10-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 7 (2d4 + 2) Fire damage.\
      ...
      \ carried, it starts [burning](3.Mechanics/traps-hazards/burning-xphb.md)."
    "name": "Touch"
"bonus_actions":
  - "desc": "The magmin sets itself ablaze or extinguishes its flames. While ablaze,\
      \ the magmin sheds [Bright Light](3.Mechanics/rules/variant-rules/bright-light-xphb.md)\
