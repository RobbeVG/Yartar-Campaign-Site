...
| [Disengage](3.Mechanics/rules/actions.md#Disengage) | Your movement doesn't provoke [Opportunity Attack](3.Mechanics/rules/actions.md#Opportunity%20Attack) for the rest of the turn. |
| [Dodge](3.Mechanics/rules/actions.md#Dodge) | Until the start of your next turn, attack rolls against you have [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md), and you make Dexterity saving throws with [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md). You lose this benefit if you have the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition or if your Speed is 0. |
