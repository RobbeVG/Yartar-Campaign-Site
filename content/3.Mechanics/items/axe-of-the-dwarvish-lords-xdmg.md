...
The axe has [Thrown](3.Mechanics/rules/item-properties.md#Thrown) with a normal range of 20 feet and a long range of 60 feet. When you hit with a ranged attack using this weapon, it deals an extra `dice:1d8|noform|noparens|avg` (`1d8`) Force damage, or an extra `dice:2d8|noform|noparens|avg` (`2d8`) Force damage if the target is a creature of the Giant type. Immediately after hitting or missing, the weapon flies back to your hand.

## Blessings of Moradin

While attuned to the axe, you gain the following benefits:

- **Darkvision.** You gain [Darkvision](3.Mechanics/rules/senses.md#Darkvision) with a range of 60 feet. If you already have [Darkvision](3.Mechanics/rules/senses.md#Darkvision), its range increases by 60 feet.  
- **Fortitude of Stone.** Your Constitution increases by 2, to a maximum of 20.  
- **Gifts of the Creator.** You have proficiency with [Brewer's Supplies](3.Mechanics/items/brewers-supplies-xphb.md), [Mason's Tools](3.Mechanics/items/masons-tools-xphb.md), and [Smith's Tools](3.Mechanics/items/smiths-tools-xphb.md).  
- **One with the Forge.** You have [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md) to Poison damage and [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) to Fire damage.  
- **Sunder.** When you hit an object with the axe, the object takes the maximum amount of damage possible.  

## Conjure Earth Elemental

While holding the axe, you can take a [Magic](3.Mechanics/rules/actions.md#Magic) action to summon an [Earth Elemental](3.Mechanics/bestiary/elemental/earth-elemental-xmm.md). It appears in an unoccupied space you choose within 30 feet of yourself, understands your languages, obeys your commands, and takes its turn immediately after you on your [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md) count. The elemental disappears after 24 hours, when it dies, or when you dismiss it as a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md). You can't use this property again until the next dawn.
