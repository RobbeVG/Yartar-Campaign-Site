...
Up to five creatures of your choice who remain within range for the spell's entire casting gain the benefits of a [Short Rest](short-rest-xphb.md) and also regain `dice:2d8|noform|noparens|avg` (`2d8`) [Hit Points](hit-points-xphb.md). A creature can't be affected by this spell again until that creature finishes a [Long Rest](long-rest-xphb.md).
