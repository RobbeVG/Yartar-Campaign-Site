...
- **School of Necromancy.** [Vampires](3.Mechanics/bestiary/undead/vampire-xmm.md) open a college of necromancy, attracting evil necromancers who need fresh corpses for their studies. An order of vampire hunters seeks the characters' help.  
- **Undying Monarch.** A venerable monarch clings to power by worshiping "Orcus" and becoming a [lich](3.Mechanics/bestiary/undead/lich-xmm.md).  
...
- **The Waking Deep.** A monstrous horror slumbering in the depths of the ocean stirs, driving minions such as sahuagin, [merrows](3.Mechanics/bestiary/monstrosity/merrow-xmm.md), or [dragon turtles](3.Mechanics/bestiary/dragon/dragon-turtle-xmm.md) to attack seafaring vessels.  
...
![Using a Published Setting; D&D Settings](3.Mechanics/tables/using-a-published-setting-d-d-settings-xdmg.md)
...
- **How Common Is Magic?.** Spellcasters and magic item shops might be common, rare, or practically nonexistent in your world. How readily available are spells such as [Lesser Restoration](3.Mechanics/spells/lesser-restoration-xphb.md), [Raise Dead](3.Mechanics/spells/raise-dead-xphb.md), and [Teleportation Circle](3.Mechanics/spells/teleportation-circle-xphb.md)? Is magic so widespread that it's part of daily life, or so rare that it conjures all sorts of superstitions?  
...
![Linking Adventures; Adventure Connections](3.Mechanics/tables/linking-adventures-adventure-connections-xdmg.md)
...
![Months and Festivals; Days of the Week](3.Mechanics/tables/months-and-festivals-days-of-the-week-xdmg.md)
...
![Gods of Greyhawk](3.Mechanics/tables/gods-of-greyhawk-xdmg.md)
...
The Free City of Greyhawk is ruled by a council called the Directing Oligarchy, made up of sixteen coequal rulers. This council elects its chief officer, the lord mayor—a position currently held by a human [Spy Master](3.Mechanics/bestiary/humanoid/spy-master-xmm.md) (Lawful Neutral) named Nerof Gasgol. The other directors include the captain-general and constable of the City Watch, several guild masters, priests of Boccob and Rao, the inspector of taxes, and a few influential magic-users with ties to politically active secret societies. Several of these directors represent criminal or unsavory interests, including Nerof Gasgol himself, who achieved his position and wealth as the owner of a notorious gambling den.

##### City Watch

The City Watch is a standing garrison of some eight hundred [Guards](3.Mechanics/bestiary/humanoid/guard-xmm.md) and [Veteran Warriors](3.Mechanics/bestiary/humanoid/warrior-veteran-xmm.md). Bolstering these defenders are [Mages](3.Mechanics/bestiary/humanoid/mage-xmm.md) from the city's Guild of Wizardry, as well as [Priests](3.Mechanics/bestiary/humanoid/priest-xmm.md) from local temples.
...
The captain-general of the City Watch is Sental Nurev, a tall, human [Warrior Veteran](3.Mechanics/bestiary/humanoid/warrior-veteran-xmm.md) (Neutral Good) with thinning blond hair and a mustache. Sental is usually incorruptible, but he is under great stress. The rulers of Stoink, a fortified town in the Bandit Kingdoms, have captured Sental's brother Sarek and are forcing the captain-general to provide information about Greyhawk's defenses and local politicians. Sental gives this information to a human [Spy](3.Mechanics/bestiary/humanoid/spy-xmm.md) (Chaotic Evil) who stays at the Black Dragon Inn under the false name Skanda Drond. Sental is unaware that the bandit lords of Stoink are pawns of Iuz, whose dreams of conquest extend to the Free City of Greyhawk and far beyond.

The city's constable—who serves as second-in-command to the captain-general, manager to the members of the watch, and a member of the Directing Oligarchy—is a compassionate [Priest](3.Mechanics/bestiary/humanoid/priest-xmm.md) of Pelor named Derider Fanshen (Neutral Good). Her kindness and talent for healing make her well loved among the watch, and as a former adventurer, she is sympathetic to adventurers' needs. She's unaware of Sental's compromised position.

###### Character Backgrounds

Adventurers with the [Criminal](3.Mechanics/backgrounds/criminal-xphb.md) or [Guard](3.Mechanics/backgrounds/guard-xphb.md) background might have a connection to the Grand Citadel involving a past run-in with the law or past service on the watch.
...
Weapons and armor aren't permitted in the Great Library. If anyone wearing armor or carrying a visible weapon tries to enter the library, or if a thief is spotted trying to leave the library with one or more stolen books, the stone-carved bronze dragons flanking the entrance animate and attack. These statues are [Stone Golems](3.Mechanics/bestiary/construct/stone-golem-xmm.md).

Abra Saghast, a crusty and irascible dragonborn sage, serves as the head librarian. Abra, an [Archmage](3.Mechanics/bestiary/humanoid/archmage-xmm.md) (Chaotic Good), has bright-green eyes, and her bronze scales are tinged with aquamarine blue. She typically wears a patchwork robe.
...
An iron door leads to a hallway behind the head librarian's desk. Three scribes ([Mages](3.Mechanics/bestiary/humanoid/mage-xmm.md)) labor here and act as sentries, for next to their desks are three locked, iron doors to the library's vaults. [Arcane Lock](3.Mechanics/spells/arcane-lock-xphb.md) spells seal these doors, beyond which are repositories for the library's most valuable or scandalous works. Next to each scribe's desk is a pull cord hanging through a hole in the ceiling. A tug on any one of these cords releases a homing pigeon from a loft above the library. It takes the bird 1 minute to find and alert an [Archmage](3.Mechanics/bestiary/humanoid/archmage-xmm.md), who teleports to the main hall of the library to investigate.

###### Character Backgrounds

Adventurers with the [Sage](3.Mechanics/backgrounds/sage-xphb.md) or [Scribe](3.Mechanics/backgrounds/scribe-xphb.md) background might have a connection to the Great Library and its proprietor.
...
- **Spell Scrolls.** Adventurers can commission the scribes to create a [Spell Scroll](3.Mechanics/items/spell-scroll-xdmg.md) that bears a Wizard spell of level 5 or lower. See the "Player's Handbook" for the time required to "craft a scroll"; the scribes charge double the cost shown there.  
...
Adventurers with the [Merchant](3.Mechanics/backgrounds/merchant-xphb.md) or [Noble](3.Mechanics/backgrounds/noble-xphb.md) background might have a connection to the High Tower Inn, which caters to people of means.
...
Weapons larger than daggers must be checked at the door, together with shields. Customers wearing metal armor aren't admitted. Two bouncers (Neutral [Tough Bosses](3.Mechanics/bestiary/humanoid/tough-boss-xmm.md)) stand at the door, politely enforcing the rule.

The inn's married human proprietors, Olaf Al-Azul (Chaotic Good [Warrior Veteran](3.Mechanics/bestiary/humanoid/warrior-veteran-xmm.md)) and Sivan Al-Azul (Chaotic Neutral [Assassin](3.Mechanics/bestiary/humanoid/assassin-xmm.md)), speak multiple languages and use humor to raise spirits and diffuse tensions. Olaf can almost always break up a fight before it starts, generally with a round of drinks for the instigators. Sivan is quiet and introspective, but he always keeps a hilarious joke or cutting remark at the ready.

###### Character Backgrounds

Adventurers with the [Artisan](3.Mechanics/backgrounds/artisan-xphb.md) or [Entertainer](3.Mechanics/backgrounds/entertainer-xphb.md) background might do business with the Silver Dragon Inn.
...
Situated in the Garden Quarter, this temple is dedicated to Fharlanghn, a god favored by travelers and mercenaries. The [Priests](3.Mechanics/bestiary/humanoid/priest-xmm.md) who staff the temple offer nourishment, rest, and healing to those in need, day and night. Several small rooms are maintained for guests, and simple, hot meals are free to all visitors.

###### Character Backgrounds

Adventurers with the [Guide](3.Mechanics/backgrounds/guide-xphb.md) or [Sailor](3.Mechanics/backgrounds/sailor-xphb.md) background might have a connection to the temple, which offers help to travelers.
...
- **Healing.** Adventurers can purchase [Potions of Healing](3.Mechanics/items/potion-of-healing-xdmg.md) for 50 GP each, and the temple's priests have `dice:1d4|noform|noparens|avg` (`1d4`) such potions in stock on any given day. The priests also have [Cure Wounds](3.Mechanics/spells/cure-wounds-xphb.md) and [Lesser Restoration](3.Mechanics/spells/lesser-restoration-xphb.md) spells prepared and customarily cast them for free. For more powerful magic, such as [Greater Restoration](3.Mechanics/spells/greater-restoration-xphb.md) and [Raise Dead](3.Mechanics/spells/raise-dead-xphb.md) spells, the priests direct the adventurers to the Temple of the Radiant Sun.  
...
- **Teleportation Circle.** Though it isn't the only permanent teleportation circle in the city, the circle within the Temple of the Far Horizon is the easiest to access. The priests allow free access to the teleportation circle in either direction. For 2,000 GP, the chief priest will cast the [Teleportation Circle](3.Mechanics/spells/teleportation-circle-xphb.md) spell to open a connection to another permanent circle on the Material Plane.  
...
This temple, dedicated to serving the god Pelor in the heart of the Garden Quarter, opens at dawn and closes at dusk. In a sanctuary in the heart of the temple, [Priests](3.Mechanics/bestiary/humanoid/priest-xmm.md) conduct daily morning rites, as well as all-day observances every Godsday.

Sarana, the temple's [Archpriest](3.Mechanics/bestiary/humanoid/archpriest-xmm.md) (Neutral Good), is a middle-aged, human woman wearing a sun-shaped headdress and yellow-and-gold robes. She is never seen in public without her [Staff of Healing](3.Mechanics/items/staff-of-healing-xdmg.md). Sarana has straw-colored hair, green eyes, and a forgiving nature.

###### Character Backgrounds

Adventurers with the [Acolyte](3.Mechanics/backgrounds/acolyte-xphb.md) background might have served in the Temple of the Radiant Sun, while those with the Farmer background might seek it out as a place for blessing.

###### Reasons to Visit

Adventurers might visit the temple for one of the following reasons:

- **Healing.** The temple sells [Spell Scrolls](3.Mechanics/items/spell-scroll-xdmg.md) of [Greater Restoration](3.Mechanics/spells/greater-restoration-xphb.md) for 3,200 GP apiece and [Spell Scrolls](3.Mechanics/items/spell-scroll-xdmg.md) of [Remove Curse](3.Mechanics/spells/remove-curse-xphb.md) for 300 GP apiece, and the priests have `dice:1d3|noform|noparens|avg` (`1d3`) copies of each scroll in stock on any given day. The priests also have [Cure Wounds](3.Mechanics/spells/cure-wounds-xphb.md) and [Lesser Restoration](3.Mechanics/spells/lesser-restoration-xphb.md) spells prepared, which they customarily cast for free.  
- **Raise Dead.** Archpriest Sarana is one of a handful of people in the Free City of Greyhawk who can cast the [Raise Dead](3.Mechanics/spells/raise-dead-xphb.md) spell, but she needs the requisite 500 GP diamond to do so. Sarana can recommend a jeweler who sells diamonds of sufficient value. Before agreeing to cast the spell, Sarana casts [Zone of Truth](3.Mechanics/spells/zone-of-truth-xphb.md) and asks questions about the deceased individual to make sure she's not returning to life someone who should stay dead.  
...
Adventurers with the [Charlatan](3.Mechanics/backgrounds/charlatan-xphb.md) or [Hermit](3.Mechanics/backgrounds/hermit-xphb.md) background might have a connection to Unearthed Arcana, as Morley has a variety of unusual interests.
...
- **Magic Item Identification.** Morley can cast the [Identify](3.Mechanics/spells/identify-xphb.md) spell at will. He charges 50 GP for each casting of the spell.  
...
- **Mistmarsh.** This vast swamp holds the half-sunken ruins of an ancient city that is now shrouded by fog and guarded by a family of black dragons. [Will-o'-wisps](3.Mechanics/bestiary/undead/will-o-wisp-xmm.md) lure prey to the ruins, where doom awaits.  
...
> - **Scholarly Expertise.** Characters who have proficiency in the [Arcana](3.Mechanics/rules/skills.md#Arcana), [History](3.Mechanics/rules/skills.md#History), or [Religion](3.Mechanics/rules/skills.md#Religion) skill can be fonts of useful information. When it would be helpful for a group to know something about the setting, ask such characters to make an Intelligence check using the relevant skill, then share plot-relevant details if their roll warrants it.  
> - **Magical Footnotes.** Spells such as [Contact Other Plane](3.Mechanics/spells/contact-other-plane-xphb.md), [Legend Lore](3.Mechanics/spells/legend-lore-xphb.md), and [Speak with Dead](3.Mechanics/spells/speak-with-dead-xphb.md) allow characters to learn information while leaving you control of the particulars.  
...
![Central Flanaess Locations](3.Mechanics/tables/central-flanaess-locations-xdmg.md)
...
![Eastern Flanaess Locations](3.Mechanics/tables/eastern-flanaess-locations-xdmg.md)
...
![Northern Flanaess Locations](3.Mechanics/tables/northern-flanaess-locations-xdmg.md)
...
![Old Keoland Locations](3.Mechanics/tables/old-keoland-locations-xdmg.md)
...
![Western Flanaess Locations](3.Mechanics/tables/western-flanaess-locations-xdmg.md)
