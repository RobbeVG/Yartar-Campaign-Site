...
"cr": "1"
"traits":
  - "desc": "The imp has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Piercing damage\
    ...
    "name": "Sting"
  - "desc": "The imp shape-shifts to resemble a rat ([Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
      ...
      \ except for its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md). Any\
      \ equipment it is wearing or carrying isn't transformed."
    "name": "Shape-Shift"
  - "desc": "The imp casts [Invisibility](3.Mechanics/spells/invisibility-xphb.md)\
