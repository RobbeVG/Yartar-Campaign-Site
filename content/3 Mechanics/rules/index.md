...
FROM "3 Mechanics/rules"
WHERE !draft AND file != this.file
SORT title ASC
-->
<!-- SerializedQuery: LIST WITHOUT ID link(file.link, title) FROM "3 Mechanics/rules" WHERE !draft AND file != this.file SORT title ASC -->
...
- [[3 Mechanics/rules/variant-rules/index.md|Variant-rules]]
