...
"actions":
  ...
  - "desc": "The frog swallows a Small or smaller target it is grappling. While swallowed,\
      ...
      \ dice:2d4|noform|noparens|avg|text(5) (2d4) Acid damage. If that damage\
      \ doesn't kill it, the frog disgorges it, causing it to exit [Prone](3.Mechanics/rules/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Giant%20Frog.webp"
```
^statblock
