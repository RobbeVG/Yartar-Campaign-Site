...
| dice: 1d100 | Effect |
|-------------|--------|
| 01-20 | You cast a spell originating from the chosen point. Roll `dice:1d10\|noform\|noparens\|avg` (`1d10`) to determine the spell: on a **1-2**, [Darkness](3%20Mechanics/spells/darkness-xphb.md); on a **3-4**, [Faerie Fire](faerie-fire-xphb.md); on a **5-6**, [Fireball](fireball-xphb.md); on a **7-8**, [Slow](slow-xphb.md); on a **9-10**, [Stinking Cloud](stinking-cloud-xphb.md). |
...
| 93-97 | You cast [Polymorph](polymorph-xphb.md), targeting the creature closest to the chosen point of origin. Roll `dice:1d4\|noform\|noparens\|avg` (`1d4`) to determine the target's new form. On a **1**, the new form is a [Black Bear](black-bear-xmm.md); on a **2**, the new form is a [Giant Wasp](giant-wasp-xmm.md); on a **3-4**, the new form is a [Frog](frog-xmm.md). |
