...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 18, one Large or smaller creature the behir\
      ...
      \ DC 16), and it has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
...
"bonus_actions":
  - "desc": "*Dexterity Saving Throw:* DC 18, one Large or smaller creature [Grappled](3.Mechanics/rules/conditions.md#Grappled)\
      ...
      \ creature, which falls in a space within 10 feet of the behir and has the [Prone](3.Mechanics/rules/conditions.md#Prone)\
      \ condition. If the behir dies, a swallowed creature is no longer [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
