...
"cr": "1/4"
"traits":
  - "desc": "The pseudodragon has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 12, one creature the pseudodragon can\
      ...
      \ Poison damage, and the target has the [Poisoned](3.Mechanics/rules/conditions.md#Poisoned)\
      \ condition for 1 hour. While [Poisoned](3.Mechanics/rules/conditions.md#Poisoned),\
      \ the target also has the [Unconscious](3.Mechanics/rules/conditions.md#Unconscious)\
...
"source":
  - "XMM"
  - "XPHB"
"image": "file://bestiary/tokens/XMM/Pseudodragon.webp"
```
^statblock
