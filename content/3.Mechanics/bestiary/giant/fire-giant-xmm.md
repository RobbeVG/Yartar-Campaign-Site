...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Fire%20Giant.webp#right)
...
***Flame Sword.*** *Melee Attack Roll:* `dice:1d20+11|noform|noparens|text(+11)`, reach 10 ft. *Hit:* `dice:4d6+7|noform|noparens|avg|text(21)` (`4d6 + 7`) Slashing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) Fire damage.

***Hammer Throw.*** *Ranged Attack Roll:* `dice:1d20+11|noform|noparens|text(+11)`, range 60/240 ft. *Hit:* `dice:3d10+7|noform|noparens|avg|text(23)` (`3d10 + 7`) Bludgeoning damage plus `dice:1d8|noform|noparens|avg|text(4)` (`1d8`) Fire damage, and the target is pushed up to 15 feet straight away from the giant and has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on the next attack roll it makes before the end of its next turn.
```
^statblock
