...
"actions":
  - "desc": "*Melee Attack Roll:* +8, reach 5 ft. *Hit:* 12 (2d6 + 5) Bludgeoning\
      ...
      \ extra 7 (2d6) Bludgeoning damage and has the [Prone](3.Mechanics/rules/conditions.md#Prone)\
      \ condition."
    "name": "Avalanche Slam"
  - "desc": "The galeb duhr magically animates one or two boulders it can see within\
      ...
      \ takes its turn immediately after the galeb duhr on the same [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md)\
