...
"traits":
  ...
  - "desc": "The colossus has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 26, each creature in a 300-foot-long, 10-foot-wide\
      ...
      \ dice:10d12|noform|noparens|avg|text(65) (10d12) Radiant damage. *Success:*\
      \ Half damage. *Failure or Success:* A creature reduced to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
...
"legendary_actions":
  - "desc": "The colossus makes one Radiant Ray attack."
    "name": "Smite"
  - "desc": "The colossus moves up to half its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Colossus.webp"
```
^statblock
