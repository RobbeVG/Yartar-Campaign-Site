...
Don't add your [Proficiency Bonus](3.Mechanics/rules/variant-rules/proficiency-xphb.md) to attack rolls with an improvised weapon.
...
If an improvised weapon resembles a Simple or Martial weapon, the DM may say it functions as that weapon and uses that weapon's rules. For example, the DM could treat a table leg as a [Club](3.Mechanics/items/club-xphb.md).