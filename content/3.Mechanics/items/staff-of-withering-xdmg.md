...
The staff can be wielded as a magic Quarterstaff. On a hit, it deals damage as a normal Quarterstaff , and you can expend 1 charge to deal an extra `dice:2d10|noform|noparens|avg` (`2d10`) Necrotic damage to the target and force it to make a DC 15 Constitution saving throw. On a failed save, the target has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) for 1 hour on any ability check or saving throw that uses Strength or Constitution.
