...
- **Resilience.** You have [Resistance](3%20Mechanics/rules/variant-rules/resistance-xphb.md) to Poison damage. You also have [Advantage](advantage-xphb.md) on saving throws you make to avoid or end the [Poisoned](conditions.md#Poisoned) condition.  
