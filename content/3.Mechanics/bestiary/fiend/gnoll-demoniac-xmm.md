...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* dice:1d20+6|noform|noparens|text(+6),\
      ...
      \ (5d6 + 3) Poison damage."
    "name": "Abyssal Strike"
  - "desc": "The gnoll conjures a 30-foot [Cube](3.Mechanics/rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ of magical [Darkness](3.Mechanics/rules/variant-rules/darkness-xphb.md) originating\
      \ from a point it can see within 60 feet, which lasts for 1 minute or until\
      \ the gnoll's [Concentration](3.Mechanics/rules/conditions.md#Concentration)\
      \ ends on it. This area is [Difficult Terrain](3.Mechanics/rules/variant-rules/difficult-terrain-xphb.md).\
      ...
      \ see gains 10 [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md).\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Gnoll%20Demoniac.webp"
```
^statblock
