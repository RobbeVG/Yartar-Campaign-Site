...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Magmin.webp#right)
...
***Death Burst.*** The magmin explodes when it dies. *Dexterity Saving Throw:* DC 11, each creature in a 10-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the magmin. *Failure:* `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) Fire damage. *Success:* Half damage.

## Actions

***Touch.*** *Melee Attack Roll:* `dice:1d20+4|noform|noparens|text(+4)`, reach 5 ft. *Hit:* `dice:2d4+2|noform|noparens|avg|text(7)` (`2d4 + 2`) Fire damage. If the target is a creature or a flammable object that isn't being worn or carried, it starts [burning](3.Mechanics/traps-hazards/burning-xphb.md).

## Bonus Actions

***Ignited Illumination.*** The magmin sets itself ablaze or extinguishes its flames. While ablaze, the magmin sheds [Bright Light](3.Mechanics/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](3.Mechanics/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet.
```
^statblock
