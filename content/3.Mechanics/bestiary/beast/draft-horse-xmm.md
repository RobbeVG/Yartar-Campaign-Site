...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Draft%20Horse.webp#right)
...
***Hooves.*** *Melee Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)`, reach 5 ft. *Hit:* `dice:1d4+4|noform|noparens|avg|text(6)` (`1d4 + 4`) Bludgeoning damage.
```
^statblock
