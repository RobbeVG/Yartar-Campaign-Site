...
The weapon has `dice:1d3|noform|noparens|avg` (`1d3`) charges. While holding it, you can expend 1 charge and cast [Wish](wish-xphb.md) from it. Once used, this property can't be used again until the next dawn. The weapon loses this property if it has no charges.
