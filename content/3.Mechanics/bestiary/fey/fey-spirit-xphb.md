...
- **Fuming.** The spirit has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the next attack roll it makes before the end of this turn.  
- **Mirthful.** *Wisdom Saving Throw:* DC equals your spell save DC, one creature the spirit can see within 10 feet of itself. *Failure:* The target is [Charmed](3.Mechanics/rules/conditions.md#Charmed) by you and the spirit for 1 minute or until the target takes any damage.  
- **Tricksy.** The spirit fills a 10-foot [Cube](3.Mechanics/rules/variant-rules/cube-area-of-effect-xphb.md) within 5 feet of it with magical Darkness, which lasts until the end of its next turn.  
```
^statblock