...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 17, each creature in a 60-foot [Cone](3 Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      ...
      \ Success:* A Humanoid reduced to 0 [Hit Points](3 Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ by this damage dies, and a [Shadow](3 Mechanics/bestiary/undead/shadow-xmm.md)\
      \ rises from the corpse. The shadow is under the dragon's control and shares\
      \ the dragon's [Initiative](3 Mechanics/rules/variant-rules/initiative-xphb.md)\
