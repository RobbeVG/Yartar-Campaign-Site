...
"bonus_actions":
  - "desc": "The intellect snare targets one creature it is grappling. The target\
      \ must make a DC 17 Intelligence saving throw, taking dice:6d6|noform|noparens|avg|text(21)\
      \ (6d6) psychic damage on a failed save, or half as much damage on a successful\
      \ one. The intellect snare then regains a number of hit points equal to the\
      \ amount of damage taken."
    "name": "Siphon Thoughts"
"source":
  - "PaBTSO"
"image": "file://bestiary/tokens/PaBTSO/Intellect%20Snare.webp"
```
^statblock