...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Swarm%20of%20Lemures.webp#right)
...
"cr": "3"
"traits":
  - "desc": "If the swarm dies in the Nine Hells, it revives with all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ in 1d10 days unless it is killed by a creature under the effects of a [Bless](3.Mechanics/spells/bless-xphb.md)\
      \ spell or its remains are sprinkled with [Holy Water](3.Mechanics/items/holy-water-xphb.md)."
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 11 (2d8 + 2) Poison damage,\
      \ or 9 (2d6 + 2) Poison damage if the swarm is [Bloodied](3.Mechanics/rules/conditions.md#Bloodied)."
    "name": "Vile Slime"
"source":
  - "XMM"
