...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+9|noform|noparens|text(+9), reach 5\
      ...
      \ regain [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md), it\
      \ gains no benefit from finishing a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md),\
      \ and its [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md) maximum\
      \ decreases by dice:3d6|noform|noparens|avg|text(10) (3d6) every 24 hours\
      \ that elapse. A creature dies and turns to dust if reduced to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ by this attack."
    "name": "Rotting Fist"
  ...
  - "desc": "*Wisdom Saving Throw:* DC 17, one creature the mummy can see within 60\
      ...
      \ damage, and the target has the [Paralyzed](3.Mechanics/rules/conditions.md#Paralyzed)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Mummy%20Lord.webp"
```
^statblock
