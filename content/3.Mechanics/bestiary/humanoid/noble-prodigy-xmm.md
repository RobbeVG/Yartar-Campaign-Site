...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* dice:1d20+8|noform|noparens|text(+8),\
      ...
      \ (4d6 + 4) Psychic damage, and the target has the [Charmed](3.Mechanics/rules/conditions.md#Charmed)\
  ...
  - "desc": "The noble casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Mage Armor](3.Mechanics/spells/mage-armor-xphb.md) (included in AC),\
      \ [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md), [Minor Illusion](3.Mechanics/spells/minor-illusion-xphb.md)\n\
      \n**1/day each:** [Befuddlement](3.Mechanics/spells/befuddlement-xphb.md), [Detect\
      \ Thoughts](3.Mechanics/spells/detect-thoughts-xphb.md), [Fly](3.Mechanics/spells/fly-xphb.md),\
      \ [Scrying](3.Mechanics/spells/scrying-xphb.md), [Shatter](3.Mechanics/spells/shatter-xphb.md)\
      \ (level 7 version)"
    "name": "Spellcasting"
"reactions":
  - "desc": "The noble casts [Shield](3.Mechanics/spells/shield-xphb.md) in response\
      \ to that spell's trigger, using the same spellcasting ability as Spellcasting.\n"
    "name": "Shield (2/Day)"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Noble%20Prodigy.webp"
```
^statblock
