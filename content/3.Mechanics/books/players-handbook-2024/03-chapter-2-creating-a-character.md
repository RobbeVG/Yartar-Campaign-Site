...
![Choose a Class; Class Overview](3.Mechanics/tables/choose-a-class-class-overview-xphb.md)

> [!note] A Balanced Party
> 
> The classic D&D party comprises a [Cleric](3.Mechanics/classes/cleric-xphb.md), [Fighter](3.Mechanics/classes/fighter-xphb.md), [Rogue](3.Mechanics/classes/rogue-xphb.md), and [Wizard](3.Mechanics/classes/wizard-xphb.md). Those four classes have the longest history in the game, but more importantly, they bring a balanced mix of capabilities to adventures. You're welcome to use that party setup or modify it using these guidelines:
> 
> - **Cleric.** Replace with [Bard](3.Mechanics/classes/bard-xphb.md) or [Druid](3.Mechanics/classes/druid-xphb.md)  
> - **Fighter.** Replace with [Barbarian](3.Mechanics/classes/barbarian-xphb.md), [Monk](3.Mechanics/classes/monk-xphb.md), [Paladin](3.Mechanics/classes/paladin-xphb.md), or [Ranger](3.Mechanics/classes/ranger-xphb.md)  
> - **Rogue.** Replace with [Bard](3.Mechanics/classes/bard-xphb.md) or [Ranger](3.Mechanics/classes/ranger-xphb.md)  
> - **Wizard.** Replace with [Bard](3.Mechanics/classes/bard-xphb.md), [Sorcerer](3.Mechanics/classes/sorcerer-xphb.md), or [Warlock](3.Mechanics/classes/warlock-xphb.md)  
^a-balanced-party

#### Write Your Level

Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [Experience Points](3.Mechanics/rules/variant-rules/experience-points-xphb.md) (XP).
...
![Choose a Background; Ability Scores and Backgrounds](3.Mechanics/tables/choose-a-background-ability-scores-and-backgrounds-xphb.md)
...
Your background and class both provide starting equipment. Any coins that you gain at this step can be immediately spent on equipment from "chapter 6". In addition, you can have one [trinket](3.Mechanics/items/trinket-xphb.md) at no cost at the end of this chapter.
...
![Choose Languages; Standard Languages](3.Mechanics/tables/choose-languages-standard-languages-xphb.md)
...
![Choose Languages; Rare Languages](3.Mechanics/tables/choose-languages-rare-languages-xphb.md)
...
![Ability Score Point Costs](3.Mechanics/tables/ability-score-point-costs-xphb.md)
...
![Assign Ability Scores; Standard Array by Class](3.Mechanics/tables/assign-ability-scores-standard-array-by-class-xphb.md)
...
![Determine Ability Modifiers; Ability Scores and Modifiers](3.Mechanics/tables/determine-ability-modifiers-ability-scores-and-modifiers-xphb.md)
...
> 
> Most creatures that lack the capacity for rational thought don't have alignments; they are unaligned. [Sharks](3.Mechanics/bestiary/beast/reef-shark-xmm.md) are savage predators, for example, but they aren't evil; they are unaligned.
^unaligned-creatures
...
![Alignment and Personality; Personality Traits by Alignment](3.Mechanics/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md)
...
Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([Perception](3.Mechanics/rules/skills.md#Perception)) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

<span class='abilityGeneric'>**Passive Perception.**</span>

Include all modifiers that apply to your Wisdom ([Perception](3.Mechanics/rules/skills.md#Perception)) checks. For example, if your character has a Wisdom of 15 and proficiency in the [Perception](3.Mechanics/rules/skills.md#Perception) skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
![Level 1 Hit Points by Class](3.Mechanics/tables/level-1-hit-points-by-class-xphb.md)

The character sheet includes room to note your current Hit Points when you take damage, as well as any [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md) you might gain. There's also space to track [Death Saving Throws](3.Mechanics/rules/variant-rules/death-saving-throw-xphb.md).
...
Without armor or a shield, your base [Armor Class](3.Mechanics/rules/variant-rules/armor-class-xphb.md) is 10 plus your Dexterity modifier. If your starting equipment includes armor or a Shield (or both), calculate your AC using the rules in "chapter 6". A class feature might give you a different way to calculate your AC.
...
![Level Advancement; Character Advancement](3.Mechanics/tables/level-advancement-character-advancement-xphb.md)
...
- **Adjust Hit Points and Hit Point Dice.** Each time you gain a level, you gain an additional Hit Die. Roll that die, add your Constitution modifier to the roll, and add the total (minimum of 1) to your Hit Point maximum. Instead of rolling, you can use the fixed value shown in the Fixed Hit Points by Class table.  
    ...
    ![Adjust Hit Points and Hit Point Dice; Fixed Hit Points by Class](3.Mechanics/tables/adjust-hit-points-and-hit-point-dice-fixed-hit-points-by-class-xphb.md)  
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [Fireball](3.Mechanics/spells/fireball-xphb.md), [Lightning Bolt](3.Mechanics/spells/lightning-bolt-xphb.md), and [Raise Dead](3.Mechanics/spells/raise-dead-xphb.md). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
![Starting Equipment at Higher Levels](3.Mechanics/tables/starting-equipment-at-higher-levels-xphb.md)
...
If you have multiple ways to calculate your [Armor Class](3.Mechanics/rules/variant-rules/armor-class-xphb.md), you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
![Spellcasting; Multiclass Spellcaster: Spell Slots per Spell Level](3.Mechanics/tables/spellcasting-multiclass-spellcaster-spell-slots-per-spell-level-xphb.md)
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](3.Mechanics/spells/burning-hands-xphb.md), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
When you make your character, you can roll once on the [Trinkets](3.Mechanics/items/trinket-xphb.md) table to gain a Tiny trinket, a simple item lightly touched by mystery. The DM might also use this table. It can help stock a room in a dungeon or fill a creature's pockets.