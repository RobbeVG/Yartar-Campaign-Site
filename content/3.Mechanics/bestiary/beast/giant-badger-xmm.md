...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Giant%20Badger.webp#right)
...
***Bite.*** *Melee Attack Roll:* `dice:1d20+3|noform|noparens|text(+3)`, reach 5 ft. *Hit:* `dice:2d4+1|noform|noparens|avg|text(6)` (`2d4 + 1`) Piercing damage.
```
^statblock
