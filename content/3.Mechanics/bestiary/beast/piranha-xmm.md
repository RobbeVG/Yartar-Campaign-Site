...
***Bite.*** *Melee Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)` (with [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) if the target doesn't have all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)), reach 5 ft. *Hit:* 1 Piercing damage.
```
^statblock
