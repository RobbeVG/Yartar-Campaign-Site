...
- **School of Necromancy.** [Vampires](3%20Mechanics/bestiary/undead/vampire-xmm.md) open a college of necromancy, attracting evil necromancers who need fresh corpses for their studies. An order of vampire hunters seeks the characters' help.  
- **Undying Monarch.** A venerable monarch clings to power by worshiping "Orcus" and becoming a [lich](3%20Mechanics/bestiary/undead/lich-xmm.md).  
...
- **Healing.** Adventurers can purchase [Potions of Healing](potion-of-healing-xdmg.md) for 50 GP each, and the temple's priests have `dice:1d4|noform|noparens|avg` (`1d4`) such potions in stock on any given day. The priests also have [Cure Wounds](cure-wounds-xphb.md) and [Lesser Restoration](lesser-restoration-xphb.md) spells prepared and customarily cast them for free. For more powerful magic, such as [Greater Restoration](greater-restoration-xphb.md) and [Raise Dead](raise-dead-xphb.md) spells, the priests direct the adventurers to the Temple of the Radiant Sun.  
...
- **Healing.** The temple sells [Spell Scrolls](spell-scroll-xdmg.md) of [Greater Restoration](greater-restoration-xphb.md) for 3,200 GP apiece and [Spell Scrolls](spell-scroll-xdmg.md) of [Remove Curse](remove-curse-xphb.md) for 300 GP apiece, and the priests have `dice:1d3|noform|noparens|avg` (`1d3`) copies of each scroll in stock on any given day. The priests also have [Cure Wounds](cure-wounds-xphb.md) and [Lesser Restoration](lesser-restoration-xphb.md) spells prepared, which they customarily cast for free.  
