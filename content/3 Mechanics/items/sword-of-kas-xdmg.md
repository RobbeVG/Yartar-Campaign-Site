...
You gain a +3 bonus to attack rolls and damage rolls made with the sword, which scores a [Critical Hit](critical-hit-xphb.md) on a roll of 19 or 20 on the `dice:d20|noform|noparens|avg` (`d20`) and deals an extra `dice:2d10|noform|noparens|avg` (`2d10`) Slashing damage to Undead.
...
- **Battle Hunger.** You add `dice:1d10|noform|noparens|avg` (`1d10`) to your [Initiative](initiative-xphb.md) rolls.  
...
- **Necrotic Resistance.** You have [Resistance](3%20Mechanics/rules/variant-rules/resistance-xphb.md) to Necrotic damage.  
