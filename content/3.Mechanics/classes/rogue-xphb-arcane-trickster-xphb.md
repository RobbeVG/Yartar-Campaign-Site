...
**Cantrips.** You know three cantrips: [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md) and two other cantrips of your choice from the Wizard spell list (see that class's section for its list). [Mind Sliver](3.Mechanics/spells/mind-sliver-xphb.md) and [Minor Illusion](3.Mechanics/spells/minor-illusion-xphb.md) are recommended.

Whenever you gain a Rogue level, you can replace one of your cantrips, except [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md), with another Wizard cantrip of your choice.

When you reach Rogue level 10, you learn another Wizard cantrip of your choice.

**Spell Slots.** The Arcane Trickster Spellcasting table shows how many spell slots you have to cast your level 1+ spells. You regain all expended spell slots when you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).

**Prepared Spells of 1st+ Level.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose three level 1 Wizard spells. [Charm Person](3.Mechanics/spells/charm-person-xphb.md), [Disguise Self](3.Mechanics/spells/disguise-self-xphb.md), and [Fog Cloud](3.Mechanics/spells/fog-cloud-xphb.md) are recommended.
...
**Spellcasting Focus.** You can use an [Arcane Focus](3.Mechanics/items/arcane-focus-xphb.md) as a [Spellcasting Focus](3.Mechanics/rules/variant-rules/spellcasting-focus-xphb.md) for your Wizard spells.

### Mage Hand Legerdemain (Level 3)

When you cast [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md), you can cast it as a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md), and you can make the spectral hand [Invisible](3.Mechanics/rules/conditions.md#Invisible). You can control the hand as a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md), and through it, you can make Dexterity ([Sleight of Hand](3.Mechanics/rules/skills.md#Sleight%20of%20Hand)) checks.

### Magical Ambush (Level 9)

If you have the [Invisible](3.Mechanics/rules/conditions.md#Invisible) condition when you cast a spell on a creature, it has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on any saving throw it makes against the spell on the same turn.

### Versatile Trickster (Level 13)

You gain the ability to distract targets with your [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md). When you use the Trip option of your Cunning Strike on a creature, you can also use that option on another creature within 5 feet of the spectral hand.

### Spell Thief (Level 17)

You gain the ability to magically steal the knowledge of how to cast a spell from another spellcaster.

Immediately after a creature casts a spell that targets you or includes you in its area of effect, you can take a [Reaction](3.Mechanics/rules/variant-rules/reaction-xphb.md) to force the creature to make an Intelligence saving throw. The DC equals your spell save DC. On a failed save, you negate the spell's effect against you, and you steal the knowledge of the spell if it is at least level 1 and of a level you can cast (it doesn't need to be a Wizard spell). For the next 8 hours, you have the spell prepared. The creature can't cast it until the 8 hours have passed.

Once you steal a spell with this feature, you can't use this feature again until you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).