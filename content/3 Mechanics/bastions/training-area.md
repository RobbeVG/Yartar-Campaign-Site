...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](unarmed-strike-xphb.md) or a weapon, you can take a [Reaction](reaction-xphb.md) to reduce this damage by `dice:1d4\|noform\|noparens\|avg` (`1d4`). |
...
| Unarmed Combat Expert | When you hit with your [Unarmed Strike](unarmed-strike-xphb.md) and deal damage, the attack deals an extra `dice:1d4\|noform\|noparens\|avg` (`1d4`) Bludgeoning damage. |
