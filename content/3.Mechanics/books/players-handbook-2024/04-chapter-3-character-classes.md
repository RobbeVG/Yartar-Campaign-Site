...
- [Path of the Berserker](3.Mechanics/classes/barbarian-xphb-path-of-the-berserker-xphb.md) to unleash raw violence.  
- [Path of the Wild Heart](3.Mechanics/classes/barbarian-xphb-path-of-the-wild-heart-xphb.md) to manifest kinship with animals.  
...
- [College of Dance](3.Mechanics/classes/bard-xphb-college-of-dance-xphb.md) to harness agility in battle.  
- [College of Glamour](3.Mechanics/classes/bard-xphb-college-of-glamour-xphb.md) to weave beguiling Feywild magic.  
...
- [Life Domain](3.Mechanics/classes/cleric-xphb-life-domain-xphb.md) to be a master of healing.  
- [Light Domain](3.Mechanics/classes/cleric-xphb-light-domain-xphb.md) to wield searing, warding light.  
...
- [Circle of the Land](3.Mechanics/classes/druid-xphb-circle-of-the-land-xphb.md) to draw on the magic of the environment.  
- [Circle of the Moon](3.Mechanics/classes/druid-xphb-circle-of-the-moon-xphb.md) to adopt powerful animal forms.  
...
- [Battle Master](3.Mechanics/classes/fighter-xphb-battle-master-xphb.md) to use special combat maneuvers.  
- [Champion](3.Mechanics/classes/fighter-xphb-champion-xphb.md) to strive for peak combat prowess.  
...
- [Warrior of Mercy](3.Mechanics/classes/monk-xphb-warrior-of-mercy-xphb.md) to heal or harm with a touch.  
- [Warrior of Shadow](3.Mechanics/classes/monk-xphb-warrior-of-shadow-xphb.md) to employ shadows for subterfuge.  
...
- [Oath of Devotion](3.Mechanics/classes/paladin-xphb-oath-of-devotion-xphb.md) to emulate the angels of justice.  
- [Oath of Glory](3.Mechanics/classes/paladin-xphb-oath-of-glory-xphb.md) to reach the heights of heroism.  
...
- [Beast Master](3.Mechanics/classes/ranger-xphb-beast-master-xphb.md) to bond with a primal beast.  
- [Fey Wanderer](3.Mechanics/classes/ranger-xphb-fey-wanderer-xphb.md) to manifest fey mirth and fury.  
...
- [Arcane Trickster](3.Mechanics/classes/rogue-xphb-arcane-trickster-xphb.md) to enhance stealth with spells.  
- [Assassin](3.Mechanics/classes/rogue-xphb-assassin-xphb.md) to deliver ambushes and poison.  
...
- [Aberrant Sorcery](3.Mechanics/classes/sorcerer-xphb-aberrant-sorcery-xphb.md) to use strange psionic magic.  
- [Clockwork Sorcery](3.Mechanics/classes/sorcerer-xphb-clockwork-sorcery-xphb.md) to harness cosmic forces of order.  
...
- [Archfey Patron](3.Mechanics/classes/warlock-xphb-archfey-patron-xphb.md) to teleport and wield fey magic.  
- [Celestial Patron](3.Mechanics/classes/warlock-xphb-celestial-patron-xphb.md) to heal with heavenly magic.  
...
- [Abjurer](3.Mechanics/classes/wizard-xphb-abjurer-xphb.md) to shield allies and banish foes.  
- [Diviner](3.Mechanics/classes/wizard-xphb-diviner-xphb.md) to learn the multiverse's secrets.  
- [Evoker](3.Mechanics/classes/wizard-xphb-evoker-xphb.md) to create explosive effects.  
- [Illusionist](3.Mechanics/classes/wizard-xphb-illusionist-xphb.md) to weave spells of deception.