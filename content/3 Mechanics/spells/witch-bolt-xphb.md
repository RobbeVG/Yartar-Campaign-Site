...
On each of your subsequent turns, you can take a [Bonus Action](bonus-action-xphb.md) to deal `dice:1d12|noform|noparens|avg` (`1d12`) Lightning damage to the target automatically, even if the first attack missed.

The spell ends if the target is ever outside the spell's range or if it has Total [Cover](3%20Mechanics/rules/variant-rules/cover-xphb.md) from you.
