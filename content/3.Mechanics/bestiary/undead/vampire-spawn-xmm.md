...
"traits":
  ...
  - "desc": "The vampire has these weaknesses:\n\n- **Forbiddance.** The vampire can't\
      ...
      \ damage is driven into the vampire's heart while the vampire has the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated)\
      \ condition.  \n- **Sunlight.** The vampire takes 20 Radiant damage if it starts\
      \ its turn in sunlight. While in sunlight, it has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 14, one creature within 5 feet that is\
      ...
      \ condition. *Failure:* dice:1d4+3|noform|noparens|avg|text(5) (1d4 + 3)\
      \ Piercing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6) Necrotic\
    ...
    "name": "Bite"
"bonus_actions":
  - "desc": "The vampire takes the [Dash](3.Mechanics/rules/actions.md#Dash) or [Disengage](3.Mechanics/rules/actions.md#Disengage)\
      \ action."
    "name": "Deathless Agility"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Vampire%20Spawn.webp"
```
^statblock
