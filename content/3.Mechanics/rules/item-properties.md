...
You can fire only one piece of ammunition from a Loading weapon when you use an action, a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md), or a [Reaction](3.Mechanics/rules/variant-rules/reaction-xphb.md) to fire it, regardless of the number of attacks you can normally make.
