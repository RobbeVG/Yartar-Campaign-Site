...
As a [Magic](3.Mechanics/rules/actions.md#Magic) action, a creature within 5 feet of the [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md) can attempt to overcome it, which forces the creature to make a DC 15 Charisma saving throw. On a successful save, the creature ceases to be affected by the [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md).
