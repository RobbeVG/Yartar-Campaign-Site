...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* dice:1d20+9|noform|noparens|text(+9) to hit,\
      ...
      \ Humanoid [grappled](3.Mechanics/rules/conditions.md#Grappled) by the mind\
      \ flayer. *Hit:* dice:10d10|noform|noparens|avg|text(55) (10d10) piercing\
      \ damage. If this damage reduces the target to 0 hit points, the mind flayer\
      \ kills it by extracting and devouring its brain."
    "name": "Extract Brain"
  - "desc": "The mind flayer opens a rift into the Far Realm, centered on a point\
      ...
      \ disappears and the rift closes. On a failed save, a creature takes dice:4d8|noform|noparens|avg|text(18)\
...
"source":
  - "PaBTSO"
"image": "file://bestiary/tokens/PaBTSO/Mind%20Flayer%20Clairvoyant.webp"
```
^statblock