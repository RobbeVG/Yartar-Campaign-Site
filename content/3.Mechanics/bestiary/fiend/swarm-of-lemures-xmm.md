...
"traits":
  - "desc": "If the swarm dies in the Nine Hells, it revives with all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ in dice:1d10|noform|noparens|avg (1d10) days unless it is killed by a\
      \ creature under the effects of a [Bless](3.Mechanics/spells/bless-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+4|noform|noparens|text(+4), reach 5\
      ...
      \ swarm is [Bloodied](3.Mechanics/rules/conditions.md#Bloodied)."
    "name": "Vile Slime"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Swarm%20of%20Lemures.webp"
```
^statblock
