...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Giant%20Fire%20Beetle.webp#right)
...
***Illumination.*** The beetle sheds [Bright Light](3.Mechanics/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](3.Mechanics/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet.

## Actions

***Bite.*** *Melee Attack Roll:* `dice:1d20+1|noform|noparens|text(+1)`, reach 5 ft. *Hit:* 1 Fire damage.
```
^statblock
