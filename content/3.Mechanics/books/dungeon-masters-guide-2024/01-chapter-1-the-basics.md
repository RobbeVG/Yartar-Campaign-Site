...
Everyone needs some way to take notes. During every round of combat, someone needs to keep track of [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md), [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md), conditions, and other information. Players often like to take notes about what happens in the adventure, and at least one of them should record any clues and treasure the characters collect.
...
- **Obstacles to Success.** A lock, a guard, or some other obstacle might hinder a character's ability to complete a task. In those cases, you typically call for a [D20 Test](3.Mechanics/rules/variant-rules/d20-test-xphb.md), usually an ability check. For example, a successful Dexterity ([Sleight of Hand](3.Mechanics/rules/skills.md#Sleight%20of%20Hand)) check might be needed to pick the lock, while a successful Charisma ([Persuasion](3.Mechanics/rules/skills.md#Persuasion)) check and some coins might be needed to bribe the guard. The ""Resolving Outcomes"" section in "chapter 2" gives more guidance on how to use [D20 Tests](3.Mechanics/rules/variant-rules/d20-test-xphb.md) and other tools to determine the results of characters' actions.  
- **Roleplaying.** When the players interact with other creatures, roleplay those creatures based on whether they are [Friendly](3.Mechanics/rules/variant-rules/friendly-attitude-xphb.md), [Indifferent](3.Mechanics/rules/variant-rules/indifferent-attitude-xphb.md), or [Hostile](3.Mechanics/rules/variant-rules/hostile-attitude-xphb.md). Improvise based on what you know about the creatures, their knowledge, and their motivations. Then bring these creatures to life as you describe what happens. (See the ""Running Social Interaction"" section in "chapter 2" for more advice.)  
...
Try not to end a game session in the middle of an encounter. It's difficult to keep track of information such as [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md) order and other round-by-round details between sessions. An exception to this guideline is when you purposely end a session with a cliffhanger, where the story pauses just as something monumental happens or some surprising turn of events occurs. A cliffhanger can keep players intrigued and excited until the next session.
...
> [!note] 3
> 
> The DM rolls [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md) just once for all six monsters and writes down that they'll go on Initiative count 17. The DM then goes around the table to get each player's Initiative roll. See the ""Running Combat"" section in "chapter 2" for advice about rolling and tracking Initiative.
^3
...
> [!note] 6
> 
> Asking for the spell's damage allows the DM to roll a saving throw for each monster and mark off the right amount of damage for that one. In this case, though, the monsters have [Vulnerability](3.Mechanics/rules/variant-rules/vulnerability-xphb.md) to Fire damage (because they're just dry shrubs) and so few [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) that they'll die no matter what they roll.
^6
...
- **Maeve.** Mirabella puts her thumbs together and wiggles her fingertips. *(Maeve mimics this action.)* Fire shoots out from her fingers, catching the ones on our side of the stream. [Burning Hands](3.Mechanics/spells/burning-hands-xphb.md)!  
...
- **Phillip.** Gareth holds his Holy Symbol and utters an imprecation while pointing at the closest shrub and casting [Toll the Dead](3.Mechanics/spells/toll-the-dead-xphb.md). The sound of a bell tolls, and the shrub makes a Wisdom save, DC 14.  
...
- **Maeve.** I think Borogrove would be disappointed in us if we let it escape into the woods. I'll cast [Fire Bolt](3.Mechanics/spells/fire-bolt-xphb.md), getting a 14 to hit.  
- **Jared.** You nailed it.  
...
- **Rules Aren't Physics.** The rules of the game are meant to provide a fun game experience, not to describe the laws of physics in the worlds of D&D, let alone the real world. Don't let players argue that a bucket brigade of ordinary people can accelerate a spear to light speed by all using the [Ready](3.Mechanics/rules/actions.md#Ready) action to pass the spear to the next person in line. The Ready action facilitates heroic action; it doesn't define the physical limitations of what can happen in a 6-second combat round.  
