...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Warhorse.webp#right)
...
***Hooves.*** *Melee Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)`, reach 5 ft. *Hit:* `dice:2d4+4|noform|noparens|avg|text(9)` (`2d4 + 4`) Bludgeoning damage. If the target is a Large or smaller creature and the horse moved 20+ feet straight toward it immediately before the hit, the target takes an extra `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) Bludgeoning damage and has the [Prone](3.Mechanics/rules/conditions.md#Prone) condition.
```
^statblock
