...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](3.Mechanics/spells/enlarge-reduce-xphb.md) spell for `dice:1d4|noform|noparens|avg` (`1d4`) hours (no [Concentration](3.Mechanics/rules/conditions.md#Concentration) required).
