...
The wall is an object that can be damaged and thus breached. It has AC 12 and 30 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) per 10-foot section, and it has [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md) to Cold, Poison, and Psychic damage and [Vulnerability](3.Mechanics/rules/variant-rules/vulnerability-xphb.md) to Fire damage. Reducing a 10-foot section of wall to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
...
**Classes**: [Bard](3.Mechanics/lists/list-spells-classes-bard.md); [Wizard (Evoker)](3.Mechanics/lists/list-spells-classes-evoker-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](3.Mechanics/lists/list-spells-classes-wizard.md)
