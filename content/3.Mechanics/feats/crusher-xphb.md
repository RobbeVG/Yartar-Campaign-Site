...
**Enhanced Critical.** When you score a [Critical Hit](3.Mechanics/rules/variant-rules/critical-hit-xphb.md) that deals Bludgeoning damage to a creature, attack rolls against that creature have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) until the start of your next turn.