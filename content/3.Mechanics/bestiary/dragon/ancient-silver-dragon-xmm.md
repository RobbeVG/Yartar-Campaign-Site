...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Paralyzing Breath or (B) Spellcasting to cast [Ice Knife](3.Mechanics/spells/ice-knife-xphb.md)\
      \ (level 2 version)."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* dice:1d20+17|noform|noparens|text(+17), reach\
    ...
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 24, each creature in a 90-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* dice:15d8|noform|noparens|avg|text(67) (15d8) Cold damage.\
      \ *Success:* Half damage."
    "name": "Cold Breath (Recharge 5-6)"
  - "desc": "*Constitution Saving Throw:* DC 24, each creature in a 90-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *1St Failure:* The target has the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Hold Monster](3.Mechanics/spells/hold-monster-xphb.md), [Ice Knife](3.Mechanics/spells/ice-knife-xphb.md)\
      \ (level 2 version), [Shapechange](3.Mechanics/spells/shapechange-xphb.md) (Beast\
      \ or Humanoid form only, no [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md)\
      ...
      \ required to maintain the spell)\n\n**1/day each:** [Control Weather](3.Mechanics/spells/control-weather-xphb.md),\
      \ [Ice Storm](3.Mechanics/spells/ice-storm-xphb.md) (level 7 version), [Teleport](3.Mechanics/spells/teleport-xphb.md),\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient silver dragon's lair is changed\
      ...
      \ and Storms.** While in its lair, the dragon can cast [Control Weather](3.Mechanics/spells/control-weather-xphb.md),\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Hold Monster](3.Mechanics/spells/hold-monster-xphb.md).\
  ...
  - "desc": "*Dexterity Saving Throw:* DC 23, each creature in a 60-foot-long, 10-foot-wide\
      ...
      \ dice:4d6|noform|noparens|avg|text(14) (4d6) Cold damage, and the target\
      \ is pushed up to 30 feet straight away from the dragon. *Success:* Half damage\
      \ only. *Failure or Success:* The dragon can't take this action again until\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Ancient%20Silver%20Dragon.webp"
```
^statblock
