...
***Mental Fortitude.*** The goblin has advantage on saving throws against effects that would make it have the [charmed](3.Mechanics/rules/conditions.md#Charmed) or [frightened](3.Mechanics/rules/conditions.md#Frightened) conditions.

## Actions

***Multiattack.*** The goblin makes three Psychic Blade attacks.

***Psychic Blade.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft. or range 60 ft., one creature. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) psychic damage, and the target must subtract `dice:1d4|noform|noparens|avg` (`1d4`) from the next attack roll or saving throw it makes before the end of the goblin's next turn.

***Synaptic Rend (Recharge 5-6).*** The goblin unleashes a 30-foot-radius sphere of psychic energy, centered on a point the goblin can see within 60 feet of itself. Each creature in that area must make a DC 13 Intelligence saving throw. On a failed save, a creature takes `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) psychic damage and has the [incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition until the end of the goblin's next turn. On a successful save, a creature takes half as much damage only.
...
**At will:** [mage hand](3.Mechanics/spells/mage-hand-xphb.md) (the hand is invisible), [minor illusion](3.Mechanics/spells/minor-illusion-xphb.md)

**1/day each:** [charm person](3.Mechanics/spells/charm-person-xphb.md), [dissonant whispers](3.Mechanics/spells/dissonant-whispers-xphb.md), [telekinesis](3.Mechanics/spells/telekinesis-xphb.md)
