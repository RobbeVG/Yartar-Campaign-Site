...
***Shared Resistances.*** You have [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) to Fire damage until the spell ends.
...
***Breath Weapon.*** *Dexterity Saving Throw:* DC equals your spell save DC, each creature in a 30-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* `dice:2d6|noform|noparens|avg` (`2d6`) Fire damage. *Success:* Half damage.
```
^statblock