...
Eight rays of light flash from you in a 60-foot [Cone](cone-area-of-effect-xphb.md). Each creature in the [Cone](cone-area-of-effect-xphb.md) makes a Dexterity saving throw. For each target, roll `dice:1d8|noform|noparens|avg` (`1d8`) to determine which color ray affects it, consulting the Prismatic Rays table.
