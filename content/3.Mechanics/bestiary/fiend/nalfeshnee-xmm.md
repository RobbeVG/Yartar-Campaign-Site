...
"traits":
  ...
  - "desc": "The nalfeshnee has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The nalfeshnee teleports up to 120 feet to an unoccupied space it can\
    ...
    "name": "Teleport"
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 15, each creature in a 15-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the nalfeshnee. *Failure:* dice:8d6|noform|noparens|avg|text(28)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Nalfeshnee.webp"
```
^statblock
