...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+5|noform|noparens|text(+5), reach 5\
      ...
      \ lizardfolk gains [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md)\
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+5|noform|noparens|text(+5), reach 5\
    ...
    "name": "Earthen Maul"
"bonus_actions":
  - "desc": "The lizardfolk moves up to its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
      \ or [Swim Speed](3.Mechanics/rules/variant-rules/swim-speed-xphb.md) straight\
      \ toward an enemy it can see."
    "name": "Charge"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Lizardfolk%20Sovereign.webp"
```
^statblock
