...
This tome contains information and incantations necessary to make a [flesh golem](3.Mechanics/bestiary/construct/flesh-golem-xmm.md). To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can't use a *manual of golems* and attempts to read it takes `dice:6d6|noform|noparens|avg` (`6d6`) psychic damage.
