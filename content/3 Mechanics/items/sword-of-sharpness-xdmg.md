...
When you attack a creature with this weapon and roll a 20 on the `dice:d20|noform|noparens|avg` (`d20`) for the attack roll, that target takes an extra 14 Slashing damage and gains 1 [Exhaustion](conditions.md#Exhaustion) level.
