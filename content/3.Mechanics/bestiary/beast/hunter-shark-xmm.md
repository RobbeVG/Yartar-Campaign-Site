...
***Bite.*** *Melee Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)` (with [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) if the target doesn't have all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)), reach 5 ft. *Hit:* `dice:3d6+4|noform|noparens|avg|text(14)` (`3d6 + 4`) Piercing damage.
```
^statblock
