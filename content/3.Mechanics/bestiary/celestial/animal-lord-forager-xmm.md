...
"traits":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot\
      ...
      \ originating from the animal lord. *Failure:* The target has the [Charmed](3.Mechanics/rules/conditions.md#Charmed)\
      \ condition until the end of its next turn. While [Charmed](3.Mechanics/rules/conditions.md#Charmed),\
...
"actions":
  ...
  - "desc": "The animal lord conjures an animal spirit that strikes at a creature\
      ...
      \ The animal lord gains 20 [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md)."
    "name": "Animal Spirit"
