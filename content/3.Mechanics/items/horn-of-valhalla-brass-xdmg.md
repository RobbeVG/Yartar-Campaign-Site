...
A brass horn summons 3 [Berserkers](3.Mechanics/bestiary/humanoid/berserker-xmm.md). To use the brass horn, you must have [Proficiency](3.Mechanics/rules/variant-rules/proficiency-xphb.md) with all Simple weapons.
