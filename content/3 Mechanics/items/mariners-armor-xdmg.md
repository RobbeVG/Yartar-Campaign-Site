...
While wearing this armor, you have a [Swim Speed](swim-speed-xphb.md) equal to your [Speed](speed-xphb.md). In addition, if you start your turn underwater with 0 [Hit Points](hit-points-xphb.md), you immediately regain `dice:1d4|noform|noparens|avg` (`1d4`) [Hit Points](hit-points-xphb.md). The armor can't heal anyone again until the next dawn.
