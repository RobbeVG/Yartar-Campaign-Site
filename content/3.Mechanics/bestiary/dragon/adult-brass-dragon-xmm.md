...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Sleep Breath or (B) Spellcasting to cast [Scorching Ray](3.Mechanics/spells/scorching-ray-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, each creature in a 60-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      ...
      \ *2Nd Failure:* The target has the [Unconscious](3.Mechanics/rules/conditions.md#Unconscious)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Minor Illusion](3.Mechanics/spells/minor-illusion-xphb.md),\
      \ [Scorching Ray](3.Mechanics/spells/scorching-ray-xphb.md), [Shapechange](3.Mechanics/spells/shapechange-xphb.md)\
      \ (Beast or Humanoid form only, no [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md)\
      ...
      \ required to maintain the spell), [Speak with Animals](3.Mechanics/spells/speak-with-animals-xphb.md)\n\
      \n**1/day each:** [Detect Thoughts](3.Mechanics/spells/detect-thoughts-xphb.md),\
...
"regional_effects":
  - "desc": "The area containing an adult or ancient brass dragon's lair is altered\
      ...
      \ its lair, the dragon can cast [Major Image](3.Mechanics/spells/major-image-xphb.md),\
      ...
      \ refreshing. A creature that drinks such water gains 2d4 [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 16, one creature the dragon can see within\
      \ 120 feet. *Failure:* 27 (6d8) Fire damage, and the target's [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
