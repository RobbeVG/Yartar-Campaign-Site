...
Choose one damage type, other than Force, whenever you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md). You have [Resistance](3%20Mechanics/rules/variant-rules/resistance-xphb.md) to that damage type until you choose a different one with this feature.

### Hurl Through Hell (Level 14)

Once per turn when you hit a creature with an attack roll, you can try to instantly transport the target through the Lower Planes. The target must succeed on a Charisma saving throw against your spell save DC, or the target disappears and hurtles through a nightmare landscape. The target takes `dice:8d10|noform|noparens|avg` (`8d10`) Psychic damage if it isn't a Fiend, and it has the [Incapacitated](conditions.md#Incapacitated) condition until the end of your next turn, when it returns to the space it previously occupied or the nearest unoccupied space.
