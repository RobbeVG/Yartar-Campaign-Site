...
***Lordly Presence.*** *Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the animal lord. *Failure:* The target takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) Psychic damage, and the target is magically bewildered until the end of its next turn. While bewildered, the target subtracts `dice:1d4|noform|noparens|avg` (`1d4`) from its saving throws.
...
***Animal Spirit.*** The animal lord conjures an animal spirit that strikes at a creature and then disappears. *Dexterity Saving Throw:* DC 20, one creature the animal lord can see within 120 feet. *Failure:* `dice:4d10+6|noform|noparens|avg|text(28)` (`4d10 + 6`) Radiant damage. *Success:* Half damage. *Failure or Success:* The target has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks until the end of its next turn.
