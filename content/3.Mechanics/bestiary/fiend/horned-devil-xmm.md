...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 17, one creature the devil can see within\
      ...
      \ 10 (3d6) [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ at the start of each of its turns. The wound closes after 1 minute, after\
      \ a spell restores [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ to the target, or after the target or a creature within 5 feet of it takes\
      \ an action to stanch the wound, doing so by succeeding on a DC 17 Wisdom ([Medicine](3.Mechanics/rules/skills.md#Medicine))\
      \ check."
    "name": "Infernal Tail"
"source":
  - "XMM"
