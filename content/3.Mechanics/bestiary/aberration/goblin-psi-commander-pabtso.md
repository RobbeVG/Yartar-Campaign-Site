...
---
# [Goblin Psi Commander](3.Mechanics/bestiary/aberration/goblin-psi-commander-pabtso.md)
...
"traits":
  - "desc": "When the goblin dies, its pent-up mental energy explodes in a psychic\
      ...
      \ saving throw or take dice:4d4|noform|noparens|avg|text(10) (4d4) psychic\
      \ damage."
    "name": "Mental Burst"
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Weapon Attack:* dice:1d20+6|noform|noparens|text(+6)\
      \ to hit, reach 5 ft. or range 60 ft., one creature. *Hit:* dice:2d6+4|noform|noparens|avg|text(11)\
      \ (2d6 + 4) psychic damage, and the target must subtract dice:1d4|noform|noparens|avg\
      \ (1d4) from the next attack roll or saving throw it makes before the end\
  ...
  - "desc": "The goblin unleashes a 30-foot-radius sphere of psychic energy, centered\
      ...
      \ takes dice:4d6|noform|noparens|avg|text(14) (4d6) psychic damage and has\
      \ the [incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition\
      \ until the end of the goblin's next turn. On a successful save, a creature\
  ...
  - "desc": "The goblin casts one of the following spells, requiring no spell components\
      ...
      **At will:** [mage hand](3.Mechanics/spells/mage-hand-xphb.md) (the hand is\
      \ invisible), [minor illusion](3.Mechanics/spells/minor-illusion-xphb.md)\n\n\
      **1/day each:** [charm person](3.Mechanics/spells/charm-person-xphb.md), [dissonant\
      \ whispers](3.Mechanics/spells/dissonant-whispers-xphb.md), [telekinesis](3.Mechanics/spells/telekinesis-xphb.md)"
...
"source":
  - "PaBTSO"
"image": "file://bestiary/tokens/PaBTSO/Goblin%20Psi%20Commander.webp"
```
^statblock