...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/classes/XPHB/Hunter%20Ranger.webp#right)
...
You gain one of the following feature options of your choice. Whenever you finish a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md), you can replace the chosen option with the other one.

**Colossus Slayer.** Your tenacity can wear down even the most resilient foes. When you hit a creature with a weapon, the weapon deals an extra `dice:1d8|noform|noparens|avg` (`1d8`) damage to the target if it's missing any of its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md). You can deal this extra damage only once per turn.
...
**Escape the Horde.** [Opportunity Attacks](3.Mechanics/rules/actions.md#Opportunity%20Attack) have [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) against you.

**Multiattack Defense.** When a creature hits you with an attack roll, that creature has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on all other attack rolls against you this turn.
...
When you take damage, you can take a [Reaction](3.Mechanics/rules/variant-rules/reaction-xphb.md) to give yourself [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) to that damage and any other damage of the same type until the end of the current turn.