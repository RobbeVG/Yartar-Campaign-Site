...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Sphinx%20of%20Lore.webp#right)
...
***Claw.*** *Melee Attack Roll:* `dice:1d20+8|noform|noparens|text(+8)`, reach 5 ft. *Hit:* `dice:3d6+4|noform|noparens|avg|text(14)` (`3d6 + 4`) Slashing damage.

***Mind-Rending Roar (Recharge 5-6).*** *Wisdom Saving Throw:* DC 16, each enemy in a 300-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the sphinx. *Failure:* `dice:10d6|noform|noparens|avg|text(35)` (`10d6`) Psychic damage, and the target has the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition until the start of the sphinx's next turn.
...
**At will:** [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Identify](3.Mechanics/spells/identify-xphb.md), [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md), [Minor Illusion](3.Mechanics/spells/minor-illusion-xphb.md), [Prestidigitation](3.Mechanics/spells/prestidigitation-xphb.md)

**1/day each:** [Dispel Magic](3.Mechanics/spells/dispel-magic-xphb.md), [Legend Lore](3.Mechanics/spells/legend-lore-xphb.md), [Locate Object](3.Mechanics/spells/locate-object-xphb.md), [Plane Shift](3.Mechanics/spells/plane-shift-xphb.md), [Remove Curse](3.Mechanics/spells/remove-curse-xphb.md), [Tongues](3.Mechanics/spells/tongues-xphb.md)
