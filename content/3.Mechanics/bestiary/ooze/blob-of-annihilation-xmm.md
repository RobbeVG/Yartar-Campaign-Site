...
"actions":
  ...
  - "desc": "The blob moves up to its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
      ...
      \ damage at the start of each of its turns, is suffocating, has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
      \ condition, and repeats the save at the end of each of its turns. An engulfed\
      \ creature that is reduced to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The blob lobs a slimy glob at one Large or smaller creature it can see\
      ...
      \ toward the blob, and the target has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
