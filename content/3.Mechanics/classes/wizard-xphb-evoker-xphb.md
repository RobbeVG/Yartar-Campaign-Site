...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/classes/XPHB/Evoker%20Wizard.webp#right)
...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md), you take `dice:2d12|noform|noparens|avg` (`2d12`) Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) and [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md).

Each time you use this feature again before finishing a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md), the Necrotic damage per spell level increases by `dice:1d12|noform|noparens|avg` (`1d12`).