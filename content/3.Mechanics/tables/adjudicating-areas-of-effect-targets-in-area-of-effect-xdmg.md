...
*Use this column for [Cylinders](3.Mechanics/rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md).