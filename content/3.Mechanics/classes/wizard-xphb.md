...
- **Skill Proficiencies**: *Choose 2:* [Arcana](3.Mechanics/rules/skills.md#Arcana), [History](3.Mechanics/rules/skills.md#History), [Insight](3.Mechanics/rules/skills.md#Insight), [Investigation](3.Mechanics/rules/skills.md#Investigation), [Medicine](3.Mechanics/rules/skills.md#Medicine), [Nature](3.Mechanics/rules/skills.md#Nature), or [Religion](3.Mechanics/rules/skills.md#Religion)
...
**Cantrips.** You know three Wizard cantrips of your choice. [Light](3.Mechanics/spells/light-xphb.md), [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md), and [Ray of Frost](3.Mechanics/spells/ray-of-frost-xphb.md) are recommended. Whenever you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md), you can replace one of your cantrips from this feature with another Wizard cantrip of your choice.

When you reach Wizard levels 4 and 10, you learn another Wizard cantrip of your choice, as shown in the Cantrips column of the Wizard Features table.

**Spellbook.** Your wizardly apprenticeship culminated in the creation of a unique book: your spellbook. It is a Tiny object that weighs 3 pounds, contains 100 pages, and can be read only by you or someone casting [Identify](3.Mechanics/spells/identify-xphb.md). You determine the book's appearance and materials, such as a gilt-edged tome or a collection of vellum bound with twine.

The book contains the level 1+ spells you know. It starts with six level 1 Wizard spells of your choice. [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Feather Fall](3.Mechanics/spells/feather-fall-xphb.md), [Mage Armor](3.Mechanics/spells/mage-armor-xphb.md), [Magic Missile](3.Mechanics/spells/magic-missile-xphb.md), [Sleep](3.Mechanics/spells/sleep-xphb.md), and [Thunderwave](3.Mechanics/spells/thunderwave-xphb.md) are recommended.

Whenever you gain a Wizard level after 1, add two Wizard spells of your choice to your spellbook. Each of these spells must be of a level for which you have spell slots, as shown in the Wizard Features table. The spells are the culmination of arcane research you do regularly.

**Spell Slots.** The Wizard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).
...
**Changing Your Prepared Spells.** Whenever you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells there with spells from your spellbook.

**Spellcasting Ability.** Intelligence is your spellcasting ability for your Wizard spells.

**Spellcasting Focus.** You can use an [Arcane Focus](3.Mechanics/items/arcane-focus-xphb.md) or your spellbook as a [Spellcasting Focus](3.Mechanics/rules/variant-rules/spellcasting-focus-xphb.md) for your Wizard spells.

> [!note] Expanding and Replacing a Spellbook
> 
> The spells you add to your spellbook as you gain levels reflect your ongoing magical research, but you might find other spells during your adventures that you can add to the book. You could discover a Wizard spell on a [Spell Scroll](3.Mechanics/items/spell-scroll-xdmg.md), for example, and then copy it into your spellbook.
> 
...
You can cast any spell as a [Ritual](3.Mechanics/rules/variant-rules/ritual-xphb.md) if that spell has the [Ritual](3.Mechanics/rules/variant-rules/ritual-xphb.md) tag and the spell is in your spellbook. You needn't have the spell prepared, but you must read from the book to cast a spell in this way.

### Arcane Recovery (Level 1)

You can regain some of your magical energy by studying your spellbook. When you finish a [Short Rest](3.Mechanics/rules/variant-rules/short-rest-xphb.md), you can choose expended spell slots to recover. The spell slots can have a combined level equal to no more than half your Wizard level (round up), and none of the slots can be level 6 or higher. For example, if you're a level 4 Wizard, you can recover up to two levels' worth of spell slots, regaining either one level 2 spell slot or two level 1 spell slots.

Once you use this feature, you can't do so again until you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).

### Scholar (Level 2)

While studying magic, you also specialized in another field of study. Choose one of the following skills in which you have proficiency: [Arcana](3.Mechanics/rules/skills.md#Arcana), [History](3.Mechanics/rules/skills.md#History), [Investigation](3.Mechanics/rules/skills.md#Investigation), [Medicine](3.Mechanics/rules/skills.md#Medicine), [Nature](3.Mechanics/rules/skills.md#Nature), or [Religion](3.Mechanics/rules/skills.md#Religion). You have [Expertise](3.Mechanics/rules/variant-rules/expertise-xphb.md) in the chosen skill.
...
You gain the [Ability Score Improvement](3.Mechanics/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Wizard levels 8, 12, and 16.

### Memorize Spell (Level 5)

Whenever you finish a [Short Rest](3.Mechanics/rules/variant-rules/short-rest-xphb.md), you can study your spellbook and replace one of the level 1+ Wizard spells you have prepared for your Spellcasting feature with another level 1+ spell from the book.
...
Whenever you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md), you can study your spellbook and replace one of those spells with an eligible spell of the same level from the book.
...
Choose two level 3 spells in your spellbook as your signature spells. You always have these spells prepared, and you can cast each of them once at level 3 without expending a spell slot. When you do so, you can't cast them in this way again until you finish a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md). To cast either spell at a higher level, you must expend a spell slot.