...
"traits":
  - "desc": "If the arcanaloth dies outside Gehenna, its body dissolves into ichor,\
      \ and it gains a new body instantly and revives with all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ in Gehenna."
    "name": "Fiendish Restoration"
  - "desc": "The arcanaloth has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
  ...
  - "desc": "The arcanaloth has a magic tome. While holding or carrying the tome,\
      ...
      \ 35; and [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md) to Necrotic,\
      \ Poison, and Psychic damage. The tome regains all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ create a new one when it finishes a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md)."
    "name": "Soul Tome"
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (2d4 + 5) Slashing damage\
      ...
      \ tome and can escape only if the tome is reduced to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)."
  ...
  - "desc": "The arcanaloth casts one of the following spells, requiring no Material\
      ...
      \ DC 17):\n\n**At will:** [Alter Self](3.Mechanics/spells/alter-self-xphb.md),\
      \ [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Identify](3.Mechanics/spells/identify-xphb.md),\
      \ [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md), [Prestidigitation](3.Mechanics/spells/prestidigitation-xphb.md)\n\
      \n**1/day each:** [Contact Other Plane](3.Mechanics/spells/contact-other-plane-xphb.md),\
      \ [Detect Thoughts](3.Mechanics/spells/detect-thoughts-xphb.md), [Dimension\
      \ Door](3.Mechanics/spells/dimension-door-xphb.md), [Mind Blank](3.Mechanics/spells/mind-blank-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The arcanaloth teleports up to 30 feet to an unoccupied space it can\
    ...
    "name": "Teleport"
"reactions":
  - "desc": "The arcanaloth casts [Counterspell](3.Mechanics/spells/counterspell-xphb.md)\
