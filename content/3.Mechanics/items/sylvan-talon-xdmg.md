...
![Sylvan Talon (Scimitar)](file://items/XDMG/Sylvan%20Talon.webp#right)
...
As a [Magic](3.Mechanics/rules/actions.md#Magic) action, you can use the weapon to cast [Message](3.Mechanics/spells/message-xphb.md). Once this property is used, it can't be used again until the next dawn.
