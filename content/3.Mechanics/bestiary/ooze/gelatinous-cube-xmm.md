...
"actions":
  ...
  - "desc": "The cube moves up to its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
      ...
      \ spells with a Verbal component, has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
      ...
      \ target can try to escape by taking an action to make a DC 12 Strength ([Athletics](3.Mechanics/rules/skills.md#Athletics))\
