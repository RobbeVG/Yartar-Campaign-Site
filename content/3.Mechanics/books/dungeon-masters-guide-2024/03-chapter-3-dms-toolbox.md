...
As described in the "Player's Handbook", [alignment](3.Mechanics/rules/variant-rules/alignment-xphb.md) is a roleplaying tool. It is a quick way to describe a creature's moral and ethical orientation. Like other elements of the game, it's meant to be a tool to serve you and your game, not a constraint or burden. Alignment can help your game in three ways: as a tool for player characters, as a descriptor of a creature's demeanor, and as a summary of an organization's ethos.
...
A creature's alignment can help you determine the creature's attitude in an encounter. A Chaotic Evil monster is likely to be [Hostile](3.Mechanics/rules/variant-rules/hostile-attitude-xphb.md), while a Lawful Good one is more likely to have a [Friendly](3.Mechanics/rules/variant-rules/friendly-attitude-xphb.md) attitude, ready to help those in need.

#### Personality

"Chapter 2" of the "Player's Handbook" offers a [table of brief personality traits](3.Mechanics/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md) linked to alignment that can inspire you in playing an NPC or another monster in your game.
...
Know the capabilities of the characters in your party before you make a chase an important feature of an adventure. A character with a high Speed or the right spell (such as [Dimension Door](3.Mechanics/spells/dimension-door-xphb.md), [Fly](3.Mechanics/spells/fly-xphb.md), or [Hold Monster](3.Mechanics/spells/hold-monster-xphb.md)) can often end a chase before it begins.

### Beginning a Chase

A chase requires at least one quarry and at least one pursuer. Any participants not already in [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md) order must roll Initiative as the chase begins. As in combat, each participant in the chase can take one action and move on its turn.
...
Participants in the chase are strongly motivated to take the [Dash](3.Mechanics/rules/actions.md#Dash) action every round. Pursuers who stop to cast spells and make attacks run the risk of losing their quarry, and a quarry that doesn't take the Dash action is likely to be caught.

#### Dashing

A chase participant can take the [Dash](3.Mechanics/rules/actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](3.Mechanics/rules/conditions.md#Exhaustion) level. A participant drops out of the chase if it has 5 [Exhaustion](3.Mechanics/rules/conditions.md#Exhaustion) levels. A creature can remove the [Exhaustion](3.Mechanics/rules/conditions.md#Exhaustion) levels it gained during the chase by finishing a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).

#### Spells and Attacks

A chase participant can make attacks and cast spells against other creatures within range.

Chase participants can't normally make [Opportunity Attacks](3.Mechanics/rules/actions.md#Opportunity%20Attack) against each other, since they are all assumed to be moving in the same direction at the same time. However, participants can still be the targets of [Opportunity Attacks](3.Mechanics/rules/actions.md#Opportunity%20Attack) from creatures not participating in the chase. For example, adventurers who chase a thief past a gang of ruffians might provoke [Opportunity Attacks](3.Mechanics/rules/actions.md#Opportunity%20Attack) from the ruffians.
...
If neither side gives up the chase, the quarry makes a Dexterity ([Stealth](3.Mechanics/rules/skills.md#Stealth)) check on Initiative count 0 each round, after every participant in the chase has taken its turn. If the quarry is never out of the lead pursuer's sight, the check fails automatically. Otherwise, compare the check's total to the [Passive Perception](3.Mechanics/rules/variant-rules/passive-perception-xphb.md) scores of the pursuers. If the quarry consists of multiple creatures, they all make the check separately, so it's possible for one quarry to escape while others remain in the chase.

The quarry can gain [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) or [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on its check based on the circumstances, as shown in the Escape Factors table.

![Ending a Chase; Escape Factors](3.Mechanics/tables/ending-a-chase-escape-factors-xdmg.md)

Other factors might help or hinder the quarry's ability to escape, at your discretion. For example, a quarry with a [Faerie Fire](3.Mechanics/spells/faerie-fire-xphb.md) spell cast on it might have Disadvantage on checks made to escape because it's much easier to spot.

If the total of the quarry's check is greater than the highest [Passive Perception](3.Mechanics/rules/variant-rules/passive-perception-xphb.md) score of the pursuers, the quarry escapes. If not, the chase continues for another round. Escape doesn't necessarily mean the quarry has outpaced its pursuers. For example, in a city, escape might mean the quarry ducked into a crowd or slipped around a corner, leaving no clue as to where it went.
...
Characters can create their own complications to shake off pursuers or slow their quarry (for example, casting the [Web](3.Mechanics/spells/web-xphb.md) spell in a narrow alleyway). Adjudicate these at your discretion.

![Urban Chase Complications](3.Mechanics/tables/urban-chase-complications-xdmg.md)

![Wilderness Chase Complications](3.Mechanics/tables/wilderness-chase-complications-xdmg.md)
...
You can alter a creature's size and creature type as you please. For example, you can use an [Ogre](3.Mechanics/bestiary/giant/ogre-xmm.md) stat block for a human bully—just make it a Medium Humanoid instead of a Large Giant.

#### Ability Scores

You can usually change a creature's Intelligence, Wisdom, and Charisma scores freely unless the ability is used for spellcasting. For example, a [Black Pudding](3.Mechanics/bestiary/ooze/black-pudding-xmm.md) stat block could represent a sapient alien if you raise its Intelligence and Charisma to 10 or so. It's usually best to leave its Strength, Dexterity, and Constitution scores alone, as changes to these scores can alter a monster's attack bonus, damage, [Armor Class](3.Mechanics/rules/variant-rules/armor-class-xphb.md), or [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md), which in turn can alter its [Challenge Rating](3.Mechanics/rules/variant-rules/challenge-rating-xphb.md).

#### Languages

You can change any or all of the languages the creature knows. You might want to add languages if you've made a creature sapient that wasn't before. You can also add or remove [telepathy](3.Mechanics/rules/variant-rules/telepathy-xphb.md) or other forms of communication.

#### Proficiencies

You can give a creature any skill proficiencies you want and give it [Expertise](3.Mechanics/rules/variant-rules/expertise-xphb.md) if you want it to be very skilled. If you want a creature to be good at hiding, give it Expertise in the [Stealth](3.Mechanics/rules/skills.md#Stealth) skill. If its keen senses make it an excellent tracker or otherwise adept at finding hidden foes, give it Expertise in the [Perception](3.Mechanics/rules/skills.md#Perception) skill. (You can also increase its Wisdom, as noted above.)

You can also swap a monster's saving throw proficiencies. If it has none, you can add one or two.

#### Senses

[Blindsight](3.Mechanics/rules/senses.md#Blindsight), [Darkvision](3.Mechanics/rules/senses.md#Darkvision), [Tremorsense](3.Mechanics/rules/senses.md#Tremorsense), and [Truesight](3.Mechanics/rules/senses.md#Truesight) have no bearing on a creature's Challenge Rating. You can add or remove them freely.
...
You can freely change the name and flavor of an attack, as well as its damage type. For example, you can turn an ordinary [Skeleton](3.Mechanics/bestiary/undead/skeleton-xmm.md) into an ice skeleton that deals Cold damage as it accosts characters with a blade of ice or hurls shards of ice at them.

#### Resistances and Immunities

If a creature doesn't have [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) or [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md) to one or more damage types, you can give it Resistance or Immunity to one or two damage types. You can also change the damage type of its existing Resistances and Immunities.
...
You can also use traits from other stat blocks in the "Monster Manual", provided you don't add traits that alter a creature's Hit Points, confer [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md), or change the amount of damage the creature deals to other creatures.

#### Creature Traits

- **Aversion to Fire.** If the creature takes Fire damage, it has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks until the end of its next turn.  
- **Battle Ready.** The creature has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md) rolls.  
- **Beast Whisperer.** The creature can communicate with Beasts as if they shared a common language.  
- **Death Jinx.** When the creature dies, one random creature within 10 feet of the dead creature is targeted by a [Bane](3.Mechanics/spells/bane-xphb.md) spell (save DC 13), which lasts for its full duration.  
- **Dimensional Disruption.** Disruptive energy extends from the creature in a 30-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures can't teleport to or from a space in that area. Any attempt to do so is wasted.  
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile](3.Mechanics/rules/variant-rules/hostile-attitude-xphb.md) [Imp](3.Mechanics/bestiary/fiend/imp-xmm.md) in the same space.  
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [Hostile](3.Mechanics/rules/variant-rules/hostile-attitude-xphb.md) [Ochre Jelly](3.Mechanics/bestiary/ooze/ochre-jelly-xmm.md) in the same space.  
- **Fey Ancestry.** The creature has Advantage on saving throws it makes to avoid or end the [Charmed](3.Mechanics/rules/conditions.md#Charmed) condition, and magic can't put it to sleep.  
- **Forbiddance.** The creature can't enter a residence without an invitation from one of its occupants.  
- **Gloom Shroud.** Imperceptible energy channeled from the "Shadowfell" extends from the creature in a 20-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures in that area have [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on Charisma checks and Charisma saving throws.  
- **Light.** The creature sheds [Bright Light](3.Mechanics/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](3.Mechanics/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet. As a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md), the creature can suppress this light or cause it to return. The light winks out if the creature dies.  
- **Mimicry.** The creature can mimic Beast sounds and Humanoid voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](3.Mechanics/rules/skills.md#Insight)) check.  
- **Poison Tolerant.** The creature has Advantage on saving throws it makes to avoid or end the [Poisoned](3.Mechanics/rules/conditions.md#Poisoned) condition.  
...
- **Slaad Host.** When the creature dies, a [Hostile](3.Mechanics/rules/variant-rules/hostile-attitude-xphb.md) [Slaad Tadpole](3.Mechanics/bestiary/aberration/slaad-tadpole-xmm.md) bursts from its innards in the same space.  
- **Steadfast.** The creature has [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md) to the [Frightened](3.Mechanics/rules/conditions.md#Frightened) condition while it can see an ally within 30 feet of itself.  
...
- **Warrior's Wrath.** The creature has Advantage on melee attack rolls against any [Bloodied](3.Mechanics/rules/conditions.md#Bloodied) creature.  
...
One capability can replace a similar one. For example, a [Potion of Climbing](3.Mechanics/items/potion-of-climbing-xdmg.md) could become a *Potion of Swimming*.

#### Altered Form

You can alter a magic item's form while leaving its properties intact. For example, you can turn a [Ring of the Ram](3.Mechanics/items/ring-of-the-ram-xdmg.md) into a wand or a [Cloak of Protection](3.Mechanics/items/cloak-of-protection-xdmg.md) into some other worn object (such as a circlet) without altering the item's properties.

#### Altered Damage Types

An item that deals damage of one type could instead deal damage of another type. For example, a [Flame Tongue](3.Mechanics/items/flame-tongue-xdmg.md) sword could deal Lightning damage instead of Fire damage.

#### Combining Items

You can merge the properties of two magic items of the same rarity into a single item, provided no more than one of them requires [Attunement](3.Mechanics/rules/variant-rules/attunement-xphb.md). For example, you could combine the properties of a [Helm of Comprehending Languages](3.Mechanics/items/helm-of-comprehending-languages-xdmg.md) with those of a [Helm of Telepathy](3.Mechanics/items/helm-of-telepathy-xdmg.md) into a single helmet. This makes the item more powerful (and probably increases its rarity), but it won't break your game.
...
![Power Level; Magic Item Power by Rarity](3.Mechanics/tables/power-level-magic-item-power-by-rarity-xdmg.md)
...
If the item grants a bonus that other items also grant, it's a good idea to require [Attunement](3.Mechanics/rules/variant-rules/attunement-xphb.md) so characters don't try to collect too many of those items.
...
![Spell Damage](3.Mechanics/tables/spell-damage-xdmg.md)
...
The simplest curses are created by the [Bestow Curse](3.Mechanics/spells/bestow-curse-xphb.md) spell. The effects of such curses are limited and can be ended by the [Remove Curse](3.Mechanics/spells/remove-curse-xphb.md) spell.
...
You decide how a spell like [Remove Curse](3.Mechanics/spells/remove-curse-xphb.md) affects a creature with accursed origins. For example, you might decide that a mummy was created through a curse and it can be destroyed permanently only by casting *Remove Curse* on its corpse.
...
A creature affected by such a curse should know why they're being punished and be able to learn how to end their curse, likely by symbolically righting the wrong they committed. How a spell like [Remove Curse](3.Mechanics/spells/remove-curse-xphb.md) affects a curse that's part of your adventure is up to you—the spell might merely suppress the effects of the curse for a time. Regardless, narrative curses should feel like rare, potent magic rooted in the lore of your campaign.
...
A creature that becomes the target of Demonic Possession must succeed on a DC 15 Charisma saving throw or be possessed by a bodiless demonic entity. Whenever the possessed creature rolls a 1 on a [D20 Test](3.Mechanics/rules/variant-rules/d20-test-xphb.md), the demonic entity takes control of the creature and determines the creature's behavior thereafter. At the end of each of the possessed creature's later turns, the creature makes a DC 15 Charisma saving throw, regaining control of itself on a success.

After finishing a Long Rest, a creature with Demonic Possession makes a DC 15 Charisma saving throw. On a successful save, the effect ends on the creature. A [Dispel Evil and Good](3.Mechanics/spells/dispel-evil-and-good-xphb.md) spell or any magic that removes a curse also ends the effect on it.
...
- [Cackle Fever](3.Mechanics/rules/diseases.md#Cackle%20Fever)  
- [Sewer Plague](3.Mechanics/rules/diseases.md#Sewer%20Plague)  
- [Sight Rot](3.Mechanics/rules/diseases.md#Sight%20Rot)  
...
The character has 1 Hit Point and the [Unconscious](3.Mechanics/rules/conditions.md#Unconscious) condition. The character can regain Hit Points as normal, but the character remains Unconscious until they are targeted by a [Greater Restoration](3.Mechanics/spells/greater-restoration-xphb.md) spell or experience a sudden awakening (see below).
...
You can also reward a player who describes a memory or something else occupying the dying character's thoughts with [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the Death Save.
...
It's also possible for dead characters to be brought back to life. The most common way is through spells such as [Revivify](3.Mechanics/spells/revivify-xphb.md) and [Raise Dead](3.Mechanics/spells/raise-dead-xphb.md). It's up to you to decide how easy it is for characters to access those spells if they can't cast them. The "Player's Handbook" offers suggested prices for [spellcasting services](3.Mechanics/tables/spellcasting-services-xphb.md).
...
A powerful individual finds the adventurers' bodies and has them raised from the dead, putting the adventurers in the debt of their rescuer. What if the adventurers wake up decades after their death, returned to life by a [Resurrection](3.Mechanics/spells/resurrection-xphb.md) spell cast by someone who believed they had an important role to play in this future era?
...
With the [Utilize](3.Mechanics/rules/actions.md#Utilize) action, a creature can try to force open a door that is barred or locked, doing so with a successful Strength ([Athletics](3.Mechanics/rules/skills.md#Athletics)) check. The table provides the DC of the check. For bigger doors, double or triple the Hit Points and increase the DC of the check by 5.

![Doors](3.Mechanics/tables/doors-xdmg.md)

#### Barred Door

A barred door has no lock. A creature on the barred side of the door can take the [Utilize](3.Mechanics/rules/actions.md#Utilize) action to lift the bar from its braces, allowing the door to be opened.

#### Locked Door

Characters who don't have the key to a locked door can try to pick the lock using [Thieves' Tools](3.Mechanics/items/thieves-tools-xphb.md). The Lock Complexity table tells you how long it takes to try to pick a lock based on its complexity. At the end of that time, the character picks the lock by making a successful Dexterity ([Sleight of Hand](3.Mechanics/rules/skills.md#Sleight%20of%20Hand)) check using Thieves' Tools. The DC is determined by the lock's quality, as shown in the Lock Quality table.

![Locked Door; Lock Complexity](3.Mechanics/tables/locked-door-lock-complexity-xdmg.md)

![Locked Door; Lock Quality](3.Mechanics/tables/locked-door-lock-quality-xdmg.md)
...
With the [Search](3.Mechanics/rules/actions.md#Search) action, a character can search for a secret door along a 10-foot-square section of wall and make a Wisdom ([Perception](3.Mechanics/rules/skills.md#Perception)) check. On a successful check, the character finds any secret door hidden in that section of wall as well as the mechanism to open the door. The DC of the check depends on how well the secret door is hidden, as shown in the Secret Doors table.

You can instead call for an Intelligence ([Investigation](3.Mechanics/rules/skills.md#Investigation)) check if the challenge involves deducing that a door is present from noticeable clues, rather than spotting those clues in the first place. See ""Perception"" in "chapter 2" for more advice.

![Secret Doors](3.Mechanics/tables/secret-doors-xdmg.md)
...
Typically made of iron or wood, a portcullis blocks a passage or an archway until it is raised into the ceiling by a winch and chain. Creatures within 5 feet of a lowered portcullis can make ranged attacks or cast spells through it, and they have [Three-Quarters Cover](3.Mechanics/tables/cover-xphb.md) against attacks, spells, and other effects originating from the opposite side. A portcullis can also be attacked and destroyed, using the AC and Hit Points of a metal door (if iron) or a wooden door (if wood).

Winching a portcullis up or down requires the [Utilize](3.Mechanics/rules/actions.md#Utilize) action. If a creature can't reach the winch (usually because it's on the other side of the portcullis), lifting the portcullis requires the [Utilize](3.Mechanics/rules/actions.md#Utilize) action and a successful Strength ([Athletics](3.Mechanics/rules/skills.md#Athletics)) check. The DC of the check depends on the type of portcullis, as shown in the Portcullises table.

![Portcullises](3.Mechanics/tables/portcullises-xdmg.md)
...
![Dungeons; Dungeon Quirks](3.Mechanics/tables/dungeons-dungeon-quirks-xdmg.md)
...
When you design a guard post, decide how many guards are on duty, note their [Passive Perception](3.Mechanics/rules/variant-rules/passive-perception-xphb.md) scores, and decide what they do when they notice intruders (see ""Monster Behavior"" in "chapter 4"). Some will rush headlong into a fight, while others will negotiate, sound an alarm, or flee to get help.
...
Sapient creatures often have laboratories, workshops, libraries, forges, and studios. Because such areas tend to contain valuable equipment, their doors are often locked and sometimes even warded by [Glyph of Warding](3.Mechanics/spells/glyph-of-warding-xphb.md) spells and similar effects.

### Dungeon Decay

The States of Ruin table can help you determine the general conditions of a dungeon area.

![Dungeon Decay; States of Ruin](3.Mechanics/tables/dungeon-decay-states-of-ruin-xdmg.md)
...
- [Dead Magic Zone](3.Mechanics/traps-hazards/dead-magic-zone-xdmg.md)  
- [Deep Water](3.Mechanics/traps-hazards/deep-water-xdmg.md)  
- [Extreme Cold](3.Mechanics/traps-hazards/extreme-cold-xdmg.md)  
- [Extreme Heat](3.Mechanics/traps-hazards/extreme-heat-xdmg.md)  
- [Frigid Water](3.Mechanics/traps-hazards/frigid-water-xdmg.md)  
- [Heavy Precipitation](3.Mechanics/traps-hazards/heavy-precipitation-xdmg.md)  
- [High Altitude](3.Mechanics/traps-hazards/high-altitude-xdmg.md)  
- [Planar Effects](3.Mechanics/traps-hazards/planar-effects-xdmg.md)  
- [Slippery Ice](3.Mechanics/traps-hazards/slippery-ice-xdmg.md)  
- [Strong Wind](3.Mechanics/traps-hazards/strong-wind-xdmg.md)  
- [Thin Ice](3.Mechanics/traps-hazards/thin-ice-xdmg.md)  
- [Wild Magic Zone](3.Mechanics/traps-hazards/wild-magic-zone-xdmg.md)  
...
Whenever the characters encounter something that is supernaturally frightful, use the [Frightened](3.Mechanics/rules/conditions.md#Frightened) condition as the baseline effect. Fear effects typically require a Wisdom saving throw, with a save DC set based on how terrifying the situation is. The Sample Fear DCs table provides some examples.

![Fear Effects; Sample Fear DCs](3.Mechanics/tables/fear-effects-sample-fear-dcs-xdmg.md)

Typically, a [Frightened](3.Mechanics/rules/conditions.md#Frightened) creature repeats the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
- The Frightened creature must take the [Dash](3.Mechanics/rules/actions.md#Dash) action on each of its turns and uses its movement to get farther away from the source of its fear.  
- Attack rolls against the Frightened creature have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md).  
...
![Sample Mental Stress Effects](3.Mechanics/tables/sample-mental-stress-effects-xdmg.md)
...
The character has the [Frightened](3.Mechanics/rules/conditions.md#Frightened), [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated), or [Stunned](3.Mechanics/rules/conditions.md#Stunned) condition for `dice:1d10|noform|noparens|avg` (`1d10`) minutes. This condition might be accompanied by alarming behavior or hallucinations. These effects can be suppressed with the [Calm Emotions](3.Mechanics/spells/calm-emotions-xphb.md) spell or removed by the [Lesser Restoration](3.Mechanics/spells/lesser-restoration-xphb.md) spell.

##### Long-Term Effects

The character has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on some or all ability checks for `1d10 × 10` hours, stemming from an unwillingness or inability to exert a particular set of abilities. The character might feel enervated and unable to exert much Strength, for example, or become so suspicious of others that Charisma checks are more difficult. These effects can be suppressed with the Calm Emotions spell or removed by the Lesser Restoration spell.
...
Firearm Bullets are destroyed upon use in a modern firearm. Futuristic firearms use Energy Cells that become depleted but could possibly be recharged with the proper equipment, at your discretion. An [Energy Cell](3.Mechanics/items/energy-cell-xdmg.md) weighs 1/2 lb.

![Firearms](3.Mechanics/tables/firearms-xdmg.md)
...
As an action, you can either throw a grenade at a point up to 60 feet away or use a Grenade Launcher to propel the grenade to a point up to 1,000 feet away. The grenade explodes at that point, creating a particular effect in a 20-foot-radius [Sphere](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md).

#### Fragmentation Grenade

Each creature in the [Sphere](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md) makes a DC 15 Dexterity saving throw, taking `dice:5d6|noform|noparens|avg|text(17)` (`5d6`) Piercing damage on a failed save or half as much damage on a successful one.

#### Smoke Grenade

The area of the [Sphere](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md) is [Heavily Obscured](3.Mechanics/rules/variant-rules/heavily-obscured-xphb.md) by smoke for 1 minute. A strong wind (such as the [Gust of Wind](3.Mechanics/spells/gust-of-wind-xphb.md) spell) disperses the smoke.

#### Gunpowder

Setting fire to a container full of Gunpowder causes it to explode. When a container explodes, each creature in a 10-foot-radius [Sphere](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md) centered on the container makes a DC 12 Dexterity saving throw, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) Fire damage (for a powder horn) or `dice:7d6|noform|noparens|avg|text(24)` (`7d6`) Fire damage (for a keg) on a failed save or half as much damage on a successful one.

### Alien Technology

When adventurers find a piece of technology that isn't from their world or time period, they can deduce what it is with a successful Intelligence ([Investigation](3.Mechanics/rules/skills.md#Investigation)) check, with the DC depending on the complexity of the item: DC 10 for a relatively simple item like a calculator or a lighter, or DC 20 for a complex item such as a computer, a chainsaw, or a hovercraft. You may require a separate Intelligence ([Investigation](3.Mechanics/rules/skills.md#Investigation)) check to determine whether a character can activate or operate the technology; a character who has observed the item in use or has operated a similar item either has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the check or succeeds on the check automatically (your choice).
...
**Titans** are the creations of deities. They might be manufactured on a divine forge, born from the blood spilled by a god, or otherwise brought about through divine will or substance. Some titans, including [krakens](3.Mechanics/bestiary/monstrosity/kraken-xmm.md) and the [tarrasque](3.Mechanics/bestiary/monstrosity/tarrasque-xmm.md), appear in the "Monster Manual".
...
The "Player's Handbook" describes common hazards that adventurers encounter, such as [falling](3.Mechanics/traps-hazards/falling-xphb.md) and [dehydration](3.Mechanics/traps-hazards/dehydration-xphb.md). This section details some more unusual hazards you can add to a location to make it more challenging.
...
- [Brown Mold](3.Mechanics/traps-hazards/brown-mold-xdmg.md)  
- [Fireball Fungus](3.Mechanics/traps-hazards/fireball-fungus-xdmg.md)  
- [Green Slime](3.Mechanics/traps-hazards/green-slime-xdmg.md)  
- [Inferno](3.Mechanics/traps-hazards/inferno-xdmg.md)  
- [Poisonous Gas](3.Mechanics/traps-hazards/poisonous-gas-xdmg.md)  
- [Quicksand Pit](3.Mechanics/traps-hazards/quicksand-pit-xdmg.md)  
- [Razorvine](3.Mechanics/traps-hazards/razorvine-xdmg.md)  
- [River Styx](3.Mechanics/traps-hazards/river-styx-xdmg.md)  
- [Rockslide](3.Mechanics/traps-hazards/rockslide-xdmg.md)  
- [Vicious Vine](3.Mechanics/traps-hazards/vicious-vine-xdmg.md)  
...
![Fortifications; Maintenance Costs](3.Mechanics/tables/fortifications-maintenance-costs-xdmg.md)
...
Whenever you would otherwise make a number of [D20 Tests](3.Mechanics/rules/variant-rules/d20-test-xphb.md) for identical monsters, the Mob Results table can help you determine the number of successful [D20 Tests](3.Mechanics/rules/variant-rules/d20-test-xphb.md) the monsters get without having to roll dice. Follow these steps:

- **Step 1.** Determine the minimum `dice:d20|noform|noparens|avg` (`d20`) roll the monsters need to succeed on the [D20 Test](3.Mechanics/rules/variant-rules/d20-test-xphb.md) using the following formula:  

**Roll needed** = target number−monster's bonus

- **Step 2.** Find the roll needed on the Mob Results table. If all the monsters have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the roll (for example, if they're attacking and have the Pack Tactics trait, or if they're making a saving throw against a spell and have the Magic Resistance trait), find the roll needed in the With Advantage column. If all the monsters have [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) (for example, if they're attacking a creature protected by the [Blur](3.Mechanics/spells/blur-xphb.md) spell), use the With Disadvantage column. Otherwise, use the Normal column.  
- **Step 3.** Read across the table to find a fractional number of successes you can easily apply to the group of monsters. That's the fraction of monsters that succeed on the [D20 Test](3.Mechanics/rules/variant-rules/d20-test-xphb.md).  

![Average Results; Mob Results](3.Mechanics/tables/average-results-mob-results-xdmg.md)

### Adjudicating Areas of Effect

When the characters are fighting a large number of monsters, it's not always practical to use miniatures on a battle grid or some other visual aid. So how do you determine how many monsters are affected by the Wizard's [Fireball](3.Mechanics/spells/fireball-xphb.md) spell or some other area of effect?
...
Your judgment always outweighs these guidelines, and it's fine to err on the side of affecting more creatures. For example, if eight zombies are crowded around a Fighter when the Bard centers a [Shatter](3.Mechanics/spells/shatter-xphb.md) spell on the Fighter's space, the spell's area should definitely engulf all eight zombies, even though according to the table, a 10-foot-radius [Sphere](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md) includes only three creatures.

![Adjudicating Areas of Effect; Targets in Area of Effect](3.Mechanics/tables/adjudicating-areas-of-effect-targets-in-area-of-effect-xdmg.md)
...
Eight [Zombies](3.Mechanics/bestiary/undead/zombie-xmm.md) surround and attack a Fighter. The zombies' attack bonus is +3, and the Fighter's AC is 18, so the roll needed is 15 (18−3). Finding 15 in the "Normal" column and reading across to the "Out of 8" column, the DM gets a result of 2/8—two of the zombies hit. Using the zombies' average damage (4 Bludgeoning damage), the Fighter takes 8 Bludgeoning damage.

After seeing the Fighter mauled by zombies, the Bard casts [Shatter](3.Mechanics/spells/shatter-xphb.md), centering the spell on the Fighter. (The Bard trusts that the Fighter will succeed on the Constitution saving throw and survive the resulting damage.) The spell affects a 10-foot-radius [Sphere](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md), and the Targets in Area of Effect table suggests that such an area should encompass three zombies. However, the DM decides that all eight zombies (and the Fighter) are affected. The zombies' Constitution saving throw bonus is +3, and the Bard's spell saving throw DC is 16, so the roll needed is 13 (16−3). Finding 13 in the "Normal" column and reading across to the "Out of 8" column, the DM gets a result of 3/8, so three of the zombies succeed on their saving throws.

Seeing a larger crowd of zombies in the distance, the Wizard casts [Fireball](3.Mechanics/spells/fireball-xphb.md). The spell covers a 20-foot-radius Sphere. The Targets in Area of Effect table suggests that area covers ten zombies, but the DM rules that they're densely packed together and adds `dice:1d3|noform|noparens|avg` (`1d3`), rolling a 2. So the spell engulfs twelve zombies in its area. The zombies' Dexterity saving throw modifier is −2, and the Wizard's spell save DC is 16, so the roll needed is 18 (16−[−2]). Finding 18 in the Normal column and reading across to the Out of 6 column, the DM gets a result of 1/6. Twelve times 1/6 is 2, so two of the twelve zombies succeed on the save.
...
![1: Common Names](3.Mechanics/tables/1-common-names-xdmg.md)

![2: Guttural Names](3.Mechanics/tables/2-guttural-names-xdmg.md)

![3: Lyrical Names](3.Mechanics/tables/3-lyrical-names-xdmg.md)

![4: Monosyllabic Names](3.Mechanics/tables/4-monosyllabic-names-xdmg.md)

![5: Sinister Names](3.Mechanics/tables/5-sinister-names-xdmg.md)

![6: Whimsical Names](3.Mechanics/tables/6-whimsical-names-xdmg.md)
...
Choose the NPC's [alignment](3.Mechanics/rules/variant-rules/alignment-xphb.md), which can help you sketch the outlines of an NPC's behavior and personality. See the "Player's Handbook" and ""Alignment"" in this chapter for more information.
...
For example, if you find the adventurers unexpectedly arguing with a Lawful Neutral guard, you might create a cooperative but laconic guard who is happy to help the adventurers but speaks curtly, hoping to end the conversation as quickly as possible. Or, looking at the [Imp](3.Mechanics/bestiary/fiend/imp-xmm.md) stat block in the "Player's Handbook" and noting its highest ability (Dexterity) and its lowest (Strength), you might decide that the little devil is fidgety and indirect, constantly on the move and talking in circles to get to its point
...
![NPC Appearance](3.Mechanics/tables/npc-appearance-xdmg.md)
...
You can use different stat blocks in the "Monster Manual", perhaps with some tweaks, to reflect the same NPC at different times as they grow over the course of a campaign. For example, characters on their very first adventure might face a villain who uses the stat block of a [Mage Apprentice](3.Mechanics/bestiary/humanoid/mage-apprentice-xmm.md), only to have that villain escape and return many adventures later to haunt them as a [Mage](3.Mechanics/bestiary/humanoid/mage-xmm.md). Still later, the same villain might reappear as an [Archmage](3.Mechanics/bestiary/humanoid/archmage-xmm.md). Of course, the trick here is making sure that the villain survives from one adventure to the next, or at least coming up with a plausible way for the villain to return from death. After all, death is rarely the final word for adventurers, so it needn't be for their opponents.
...
- **Milquetoast Healer.** Absent a healer of their own, the characters might love an NPC healer whose personality matters less than the healer's devotion to the party and ability to cast [Cure Wounds](3.Mechanics/spells/cure-wounds-xphb.md) or [Revivify](3.Mechanics/spells/revivify-xphb.md) when needed.  
...
- **Ingested.** A creature must swallow an entire dose of ingested poison to suffer its effects. The dose can be delivered in food or a liquid. You may decide that a partial dose has a reduced effect, such as allowing [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on the saving throw or dealing only half as much damage on a failed save.  
- **Inhaled.** Poisonous powders and gases take effect when inhaled. Blowing the powder or releasing the gas subjects creatures in a 5-foot [Cube](3.Mechanics/rules/variant-rules/cube-area-of-effect-xphb.md) to its effect. The resulting cloud dissipates immediately afterward. Holding one's breath is ineffective against inhaled poisons, as they affect nasal membranes, tear ducts, and other parts of the body.  
...
A character can attempt to harvest poison from a venomous creature that is dead or has the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition. The effort takes `dice:1d6|noform|noparens|avg` (`1d6`) minutes, after which the character makes a DC 20 Intelligence ([Nature](3.Mechanics/rules/skills.md#Nature)) check using a [Poisoner's Kit](3.Mechanics/items/poisoners-kit-xphb.md). On a successful check, the character harvests enough poison for a single dose, and no additional poison can be harvested from that creature. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.
...
- [Assassin's Blood](3.Mechanics/items/assassins-blood-xdmg.md)  
- [Burnt Othur Fumes](3.Mechanics/items/burnt-othur-fumes-xdmg.md)  
- [Carrion Crawler Mucus](3.Mechanics/items/carrion-crawler-mucus-xdmg.md)  
- [Essence of Ether](3.Mechanics/items/essence-of-ether-xdmg.md)  
- [Lolth's Sting](3.Mechanics/items/lolths-sting-xdmg.md)  
- [Malice](3.Mechanics/items/malice-xdmg.md)  
- [Midnight Tears](3.Mechanics/items/midnight-tears-xdmg.md)  
- [Oil of Taggit](3.Mechanics/items/oil-of-taggit-xdmg.md)  
- [Pale Tincture](3.Mechanics/items/pale-tincture-xdmg.md)  
- [Purple Worm Poison](3.Mechanics/items/purple-worm-poison-xdmg.md)  
- [Serpent Venom](3.Mechanics/items/serpent-venom-xdmg.md)  
- [Torpor](3.Mechanics/items/torpor-xdmg.md)  
- [Truth Serum](3.Mechanics/items/truth-serum-xdmg.md)  
- [Wyvern Poison](3.Mechanics/items/wyvern-poison-xdmg.md)  
...
![Level-Based Renown](3.Mechanics/tables/level-based-renown-xdmg.md)
...
![Settlement Tables and Tracker; Defining Traits](3.Mechanics/tables/settlement-tables-and-tracker-defining-traits-xdmg.md)

![Settlement Tables and Tracker; Claims to Fame](3.Mechanics/tables/settlement-tables-and-tracker-claims-to-fame-xdmg.md)

![Settlement Tables and Tracker; Current Calamities](3.Mechanics/tables/settlement-tables-and-tracker-current-calamities-xdmg.md)

![Settlement Tables and Tracker; Local Leaders](3.Mechanics/tables/settlement-tables-and-tracker-local-leaders-xdmg.md)

![Settlement Tables and Tracker; Tavern Names](3.Mechanics/tables/settlement-tables-and-tracker-tavern-names-xdmg.md)
...
- [Ballista](3.Mechanics/objects/ballista-xdmg.md)  
- [Cannon](3.Mechanics/objects/cannon-xdmg.md)  
- [Flamethrower Coach](3.Mechanics/objects/flamethrower-coach-xdmg.md)  
- [Lightning Cannon](3.Mechanics/objects/lightning-cannon-xdmg.md)  
- [Mangonel](3.Mechanics/objects/mangonel-xdmg.md)  
- [Ram](3.Mechanics/objects/ram-xdmg.md)  
- [Siege Tower](3.Mechanics/objects/siege-tower-xdmg.md)  
- [Suspended Cauldron](3.Mechanics/objects/suspended-cauldron-xdmg.md)  
- [Trebuchet](3.Mechanics/objects/trebuchet-xdmg.md)  
...
There is no limit on the number of Blessings a character can receive, but it should be rare for a character to have more than one at a time. Moreover, a character can't benefit from multiple instances of a Blessing at the same time. For example, a character can't benefit from two instances of the [Blessing of Health](3.Mechanics/rewards/blessing-of-health-xdmg.md) at once.

You can easily create more Blessings by mimicking the properties of a Wondrous Item.

- [Blessing of Health](3.Mechanics/rewards/blessing-of-health-xdmg.md)  
- [Blessing of Magic Resistance](3.Mechanics/rewards/blessing-of-magic-resistance-xdmg.md)  
- [Blessing of Protection](3.Mechanics/rewards/blessing-of-protection-xdmg.md)  
- [Blessing of Understanding](3.Mechanics/rewards/blessing-of-understanding-xdmg.md)  
- [Blessing of Valhalla](3.Mechanics/rewards/blessing-of-valhalla-xdmg.md)  
- [Blessing of Weapon Enhancement](3.Mechanics/rewards/blessing-of-weapon-enhancement-xdmg.md)  
- [Blessing of Wound Closure](3.Mechanics/rewards/blessing-of-wound-closure-xdmg.md)  
...
Some Charms can be used only once; others can be used a specific number of times before vanishing. If a Charm lets a character cast a spell, the character can do so without expending a spell slot or providing any spell components. Unless otherwise stated, the spell uses its normal casting time, range, and duration; if the spell requires [Concentration](3.Mechanics/rules/conditions.md#Concentration), the character must concentrate.

A Charm can't be removed from a creature by anything short of divine intervention or a [Wish](3.Mechanics/spells/wish-xphb.md) spell. A character can't benefit from multiple instances of a Charm at the same time.

A typical Charm mimics the effects of a Potion or spell, so it is easy to create more Charms of your own.

- [Charm of Animal Conjuring](3.Mechanics/rewards/charm-of-animal-conjuring-xdmg.md)  
- [Charm of Darkvision](3.Mechanics/rewards/charm-of-darkvision-xdmg.md)  
- [Charm of Feather Falling](3.Mechanics/rewards/charm-of-feather-falling-xdmg.md)  
- [Charm of Heroism](3.Mechanics/rewards/charm-of-heroism-xdmg.md)  
- [Charm of Restoration](3.Mechanics/rewards/charm-of-restoration-xdmg.md)  
- [Charm of the Slayer](3.Mechanics/rewards/charm-of-the-slayer-xdmg.md)  
- [Charm of Vitality](3.Mechanics/rewards/charm-of-vitality-xdmg.md)  
...
- [Collapsing Roof](3.Mechanics/traps-hazards/collapsing-roof-xdmg.md)  
- [Falling Net](3.Mechanics/traps-hazards/falling-net-xdmg.md)  
- [Fire-Casting Statue](3.Mechanics/traps-hazards/fire-casting-statue-xdmg.md)  
- [Hidden Pit](3.Mechanics/traps-hazards/hidden-pit-xdmg.md)  
- [Poisoned Darts](3.Mechanics/traps-hazards/poisoned-darts-xdmg.md)  
- [Poisoned Needle](3.Mechanics/traps-hazards/poisoned-needle-xdmg.md)  
- [Rolling Stone](3.Mechanics/traps-hazards/rolling-stone-xdmg.md)  
- [Spiked Pit](3.Mechanics/traps-hazards/spiked-pit-xdmg.md)  
...
![Building Your Own Traps; Building a Trap](3.Mechanics/tables/building-your-own-traps-building-a-trap-xdmg.md)