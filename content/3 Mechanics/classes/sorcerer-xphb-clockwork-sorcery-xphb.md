...
Your connection to the plane of absolute order allows you to equalize chaotic moments. When a creature you can see within 60 feet of yourself is about to roll a `dice:d20|noform|noparens|avg` (`d20`) with [Advantage](advantage-xphb.md) or [Disadvantage](disadvantage-xphb.md), you can take a [Reaction](reaction-xphb.md) to prevent the roll from being affected by [Advantage](advantage-xphb.md) and [Disadvantage](disadvantage-xphb.md).
