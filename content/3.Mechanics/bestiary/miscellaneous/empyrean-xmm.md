...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Empyreans.webp#right)
...
***Magic Resistance.*** The empyrean has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.

## Actions

***Multiattack.*** The empyrean makes two attacks, using Sacred Weapon or Divine Ray in any combination.

***Sacred Weapon.*** *Melee Attack Roll:* `dice:1d20+17|noform|noparens|text(+17)`, reach 10 ft. *Hit:* `dice:6d6+10|noform|noparens|avg|text(31)` (`6d6 + 10`) Force damage, and the target has the [Stunned](3.Mechanics/rules/conditions.md#Stunned) condition until the start of the empyrean's next turn. The target can choose not to be [Stunned](3.Mechanics/rules/conditions.md#Stunned), in which case it takes an extra 21 Force damage that bypasses [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) or [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md).
...
**At will:** [Calm Emotions](3.Mechanics/spells/calm-emotions-xphb.md), [Greater Restoration](3.Mechanics/spells/greater-restoration-xphb.md), [Pass without Trace](3.Mechanics/spells/pass-without-trace-xphb.md), [Water Breathing](3.Mechanics/spells/water-breathing-xphb.md)

**1/day each:** [Commune](3.Mechanics/spells/commune-xphb.md), [Dispel Evil and Good](3.Mechanics/spells/dispel-evil-and-good-xphb.md), [Plane Shift](3.Mechanics/spells/plane-shift-xphb.md)
...
***Bolster.*** The empyrean gains 10 [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md), and the empyrean and each ally within 30 feet of it gain [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on [D20 Tests](3.Mechanics/rules/variant-rules/d20-test-xphb.md) until the end of the empyrean's next turn. The empyrean can't take this action again until the start of its next turn.

***Shockwave of Glory.*** *Constitution Saving Throw:* DC 23, each creature in a 30-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the empyrean. *Failure:* `dice:6d8|noform|noparens|avg|text(27)` (`6d8`) Force damage, and the target has the [Prone](3.Mechanics/rules/conditions.md#Prone) condition. *Success:* Half damage only. *Failure or Success:* The empyrean can't take this action again until the start of its next turn.
