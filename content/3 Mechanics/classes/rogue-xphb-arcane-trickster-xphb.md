...
**Cantrips.** You know three cantrips: [Mage Hand](mage-hand-xphb.md) and two other cantrips of your choice from the Wizard spell list (see that class's section for its list). [Mind Sliver](mind-sliver-xphb.md) and [Minor Illusion](minor-illusion-xphb.md) are recommended.
...
**Prepared Spells of 1st+ Level.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose three level 1 Wizard spells. [Charm Person](charm-person-xphb.md), [Disguise Self](disguise-self-xphb.md), and [Fog Cloud](fog-cloud-xphb.md) are recommended.
