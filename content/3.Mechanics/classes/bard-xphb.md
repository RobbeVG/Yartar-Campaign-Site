...
- **Skill Proficiencies**: Choose 3 [skills](3.Mechanics/rules/skills.md)
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: Choose three [Musical Instruments](3.Mechanics/items/musical-instrument-xphb.md)
- **Armor Training**: [Light armor](3.Mechanics/rules/item-types.md#Light%20Armor)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](3.Mechanics/items/leather-armor-xphb.md), 2 [Dagger](3.Mechanics/items/dagger-xphb.md), [Musical Instrument](3.Mechanics/items/musical-instrument-xphb.md) of your choice, [Entertainer's Pack](3.Mechanics/items/entertainers-pack-xphb.md), 19 GP; or (B) 90 GP
...
**Using Bardic Inspiration.** As a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md), you can inspire another creature within 60 feet of yourself who can see or hear you. That creature gains one of your Bardic Inspiration dice. A creature can have only one Bardic Inspiration die at a time.

Once within the next hour when the creature fails a [D20 Test](3.Mechanics/rules/variant-rules/d20-test-xphb.md), the creature can roll the Bardic Inspiration die and add the number rolled to the `dice:d20|noform|noparens|avg` (`d20`), potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.

**Number of Uses.** You can confer a Bardic Inspiration die a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).
...
**Cantrips.** You know two cantrips of your choice from the Bard spell list. [Dancing Lights](3.Mechanics/spells/dancing-lights-xphb.md) and [Vicious Mockery](3.Mechanics/spells/vicious-mockery-xphb.md) are recommended.

Whenever you gain a Bard level, you can replace one of your cantrips with another cantrip of your choice from the Bard spell list.

When you reach Bard levels 4 and 10, you learn another cantrip of your choice from the Bard spell list, as shown in the Cantrips column of the Bard Features table.

**Spell Slots.** The Bard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Bard spell list. [Charm Person](3.Mechanics/spells/charm-person-xphb.md), [Color Spray](3.Mechanics/spells/color-spray-xphb.md), [Dissonant Whispers](3.Mechanics/spells/dissonant-whispers-xphb.md), and [Healing Word](3.Mechanics/spells/healing-word-xphb.md) are recommended.
...
**Spellcasting Focus.** You can use a [Musical Instrument](3.Mechanics/items/musical-instrument-xphb.md) as a [Spellcasting Focus](3.Mechanics/rules/variant-rules/spellcasting-focus-xphb.md) for your Bard spells.

### Expertise (Level 2)

You gain [Expertise](3.Mechanics/rules/variant-rules/expertise-xphb.md) in two of your skill proficiencies of your choice. [Performance](3.Mechanics/rules/skills.md#Performance) and [Persuasion](3.Mechanics/rules/skills.md#Persuasion) are recommended if you have proficiency in them.

At Bard level 9, you gain [Expertise](3.Mechanics/rules/variant-rules/expertise-xphb.md) in two more of your skill proficiencies of your choice.

### Jack of All Trades (Level 2)

You can add half your [Proficiency Bonus](3.Mechanics/rules/variant-rules/proficiency-xphb.md) (round down) to any ability check you make that uses a skill proficiency you lack and that doesn't otherwise use your [Proficiency Bonus](3.Mechanics/rules/variant-rules/proficiency-xphb.md).

For example, if you make a Strength ([Athletics](3.Mechanics/rules/skills.md#Athletics)) check and lack [Athletics](3.Mechanics/rules/skills.md#Athletics) proficiency, you can add half your [Proficiency Bonus](3.Mechanics/rules/variant-rules/proficiency-xphb.md) to the check.

> [!note] A Bard's Repertoire
> 
> Does your Bard beat a [drum](3.Mechanics/items/drum-xphb.md) while chanting the deeds of ancient heroes? Strum a [lute](3.Mechanics/items/lute-xphb.md) while crooning romantic tunes? Perform arias of stirring power? Recite dramatic monologues from classic tragedies? Use the rhythm of a folk dance to coordinate the movement of allies in battle? Compose naughty limericks?
> 
...
You gain the [Ability Score Improvement](3.Mechanics/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Bard levels 8, 12, and 16.

### Font of Inspiration (Level 5)

You now regain all your expended uses of Bardic Inspiration when you finish a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [Charmed](3.Mechanics/rules/conditions.md#Charmed) or [Frightened](3.Mechanics/rules/conditions.md#Frightened) condition, you can take a [Reaction](3.Mechanics/rules/variant-rules/reaction-xphb.md) to cause the save to be rerolled, and the new roll has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md).
...
When you roll [Initiative](3.Mechanics/rules/variant-rules/initiative-xphb.md), you regain expended uses of Bardic Inspiration until you have two if you have fewer than that.

### Epic Boon (Level 19)

You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Spell Recall](3.Mechanics/feats/boon-of-spell-recall-xphb.md) is recommended.

### Words of Creation (Level 20)

You have mastered two of the Words of Creation: the words of life and death. You therefore always have the [Power Word Heal](3.Mechanics/spells/power-word-heal-xphb.md) and [Power Word Kill](3.Mechanics/spells/power-word-kill-xphb.md) spells prepared. When you cast either spell, you can target a second creature with it if that creature is within 10 feet of the first target.