...
While lit, the candle sheds [Dim Light](3.Mechanics/rules/variant-rules/dim-light-xphb.md) in a 30-foot radius. While you are within that light, you have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on [D20 Tests](3.Mechanics/rules/variant-rules/d20-test-xphb.md). In addition, a Cleric or Druid in the light can cast level 1 spells they have prepared without expending spell slots.

Alternatively, when you light the candle for the first time, you can cast [Gate](3.Mechanics/spells/gate-xphb.md) with it. Doing so destroys the candle. The portal created by the spell links to a particular Outer Plane chosen by the DM or determined by rolling on the following table.
