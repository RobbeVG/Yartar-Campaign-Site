...
You launch a mote of light at one creature or object within range. Make a ranged spell attack against the target. On a hit, the target takes `dice:1d8|noform|noparens|avg` (`1d8`) Radiant damage, and until the end of your next turn, it emits [Dim Light](dim-light-xphb.md) in a 10-foot radius and can't benefit from the [Invisible](conditions.md#Invisible) condition.
