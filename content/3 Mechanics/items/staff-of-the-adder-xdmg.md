...
When you take the [Attack](actions.md#Attack) action, you can make one of the attack rolls using the animated snake head, which has a reach of 5 feet. Apply your [Proficiency Bonus](proficiency-xphb.md) and Wisdom modifier to the attack roll. On a hit, the target takes `dice:1d6|noform|noparens|avg` (`1d6`) Piercing damage and `dice:3d6|noform|noparens|avg` (`3d6`) Poison damage.
