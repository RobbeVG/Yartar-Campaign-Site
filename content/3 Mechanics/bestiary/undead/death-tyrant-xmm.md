...
- "Death Tyrant"
---
# [Death Tyrant](3%20Mechanics/bestiary/undead/death-tyrant-xmm.md)
...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      ...
      \ target has the [Charmed](3 Mechanics/rules/conditions.md#Charmed) condition\
      ...
      \ its [Speed](3 Mechanics/rules/variant-rules/speed-xphb.md) is halved; and\
      \ it can take either an action or a [Bonus Action](3 Mechanics/rules/variant-rules/bonus-action-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing a death tyrant's lair is warped by its presence,\
      ...
      \ from a spell, it subtracts 1d10 from the number of [Hit Points](3 Mechanics/rules/variant-rules/hit-points-xphb.md)\
