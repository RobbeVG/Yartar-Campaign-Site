...
"actions":
  - "desc": "The yuan-ti makes two Poison Burst attacks, and it can use Spellcasting\
      \ to cast [Suggestion](3.Mechanics/spells/suggestion-xphb.md) if available."
    "name": "Multiattack"
  ...
  - "desc": "*Strength Saving Throw:* DC 13, one Medium or smaller creature within\
      \ 5 feet. *Failure:* 21 (4d8 + 3) Bludgeoning damage. The target has the [Grappled](3.Mechanics/rules/conditions.md#Grappled)\
