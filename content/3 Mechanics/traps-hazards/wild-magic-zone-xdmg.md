...
Whenever a creature expends a spell slot to cast a spell in a wild magic zone, roll `dice:1d20|noform|noparens|avg` (`1d20`). If you roll a 20 on the die, roll on the [Wild Magic Surge](wild-magic-surge-xphb.md) table in the "Player's Handbook" to create a magical effect.
