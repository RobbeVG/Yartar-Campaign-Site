...
***Rend.*** *Melee Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)`, reach 5 ft. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) Slashing damage.

## Bonus Actions

***Nimble Escape.*** The panther takes the [Disengage](3.Mechanics/rules/actions.md#Disengage) or [Hide](3.Mechanics/rules/actions.md#Hide) action.
```
^statblock
