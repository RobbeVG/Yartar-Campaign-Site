...
FROM "3 Mechanics/bestiary/beast"
WHERE !draft AND file != this.file
-->
<!-- SerializedQuery: LIST WITHOUT ID link(file.link, title) FROM "3 Mechanics/bestiary/beast" WHERE !draft AND file != this.file -->
- [[ape-xmm|Ape]]
...
- [[3 Mechanics/bestiary/beast/giant-insect-xphb|Giant Insect]]
