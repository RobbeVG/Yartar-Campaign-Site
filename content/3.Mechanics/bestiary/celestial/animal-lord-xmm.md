...
"traits":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot\
      ...
      \ [Charmed](3.Mechanics/rules/conditions.md#Charmed) condition until the end\
      \ of its next turn. While [Charmed](3.Mechanics/rules/conditions.md#Charmed),\
      \ the target has the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated)\
      \ condition.  \n- **Fearful (Hunter Only).** The target has the [Frightened](3.Mechanics/rules/conditions.md#Frightened)\
  ...
  - "desc": "The animal lord has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The animal lord conjures an animal spirit that strikes at a creature\
      ...
      \  \n- **Marked as Prey (Hunter Only).** The animal lord has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
      \ on attack rolls against the target until the start of the animal lord's next\
      \ turn.  \n- **Pesky Swarm (Sage Only).** The target has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md)\
  ...
  - "desc": "The animal lord casts one of the following spells, requiring no Material\
      ...
      \ [Animal Messenger](3.Mechanics/spells/animal-messenger-xphb.md), [Speak with\
      \ Animals](3.Mechanics/spells/speak-with-animals-xphb.md)\n\n**2/day each:**\
      \ [Awaken](3.Mechanics/spells/awaken-xphb.md), [Greater Restoration](3.Mechanics/spells/greater-restoration-xphb.md)\n\
      \n**1/day each:** [Animal Shapes](3.Mechanics/spells/animal-shapes-xphb.md),\
...
"legendary_actions":
  - "desc": "The animal lord moves up to its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
