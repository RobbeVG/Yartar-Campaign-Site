...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Night%20Hag.webp#right)
...
The bag has AC 15, HP 20, and [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) to all damage. The bag turns to dust if reduced to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md). If the bag is destroyed, any souls the bag is holding are released. The hag can create a new bag after 7 days.

## Actions

***Multiattack.*** The hag makes two Claw attacks.

***Claw.*** *Melee Attack Roll:* `dice:1d20+7|noform|noparens|text(+7)`, reach 5 ft. *Hit:* `dice:2d8+4|noform|noparens|avg|text(13)` (`2d8 + 4`) Slashing damage.
...
**At will:** [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Etherealness](3.Mechanics/spells/etherealness-xphb.md), [Magic Missile](3.Mechanics/spells/magic-missile-xphb.md) (level 4 version)

**2/day each:** [Phantasmal Killer](3.Mechanics/spells/phantasmal-killer-xphb.md), [Plane Shift](3.Mechanics/spells/plane-shift-xphb.md) (self only)

***Nightmare Haunting (1/Day; Requires Soul Bag).*** While on the Ethereal Plane, the hag casts [Dream](3.Mechanics/spells/dream-xphb.md), using the same spellcasting ability as Spellcasting. Only the hag can serve as the spell's messenger, and the target must be a creature the hag can see on the Material Plane. The spell fails and is wasted if the target is under the effect of the [Protection from Evil and Good](3.Mechanics/spells/protection-from-evil-and-good-xphb.md) spell or within a [Magic Circle](3.Mechanics/spells/magic-circle-xphb.md) spell.

If the target takes damage from the [Dream](3.Mechanics/spells/dream-xphb.md) spell, the target's [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md) maximum decreases by an amount equal to that damage. If the spell kills the target, its soul is trapped in the hag's soul bag, and the target can't be raised from the dead until its soul is released.
