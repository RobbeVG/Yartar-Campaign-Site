...
- **Friend of Dwarvenkind.** You have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on Charisma ([Persuasion](3.Mechanics/rules/skills.md#Persuasion)) checks made to interact with dwarves and duergar.  
...
- **Darkvision.** You have [Darkvision](3.Mechanics/rules/senses.md#Darkvision) with a range of 60 feet.  
- **Resilience.** You have [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md) to Poison damage. You also have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Poisoned](3.Mechanics/rules/conditions.md#Poisoned) condition.  
