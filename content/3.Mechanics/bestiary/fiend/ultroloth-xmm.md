...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Ultroloth.webp#right)
...
***Fiendish Restoration.*** If the ultroloth dies outside Gehenna, its body dissolves into ichor, and it gains a new body instantly, reviving with all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) somewhere in Gehenna.

***Magic Resistance.*** The ultroloth has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.

## Actions

***Multiattack.*** The ultroloth uses Hypnotic Gaze and makes two Mercurial Whip attacks.

***Mercurial Whip.*** *Melee Attack Roll:* `dice:1d20+9|noform|noparens|text(+9)`, reach 15 ft. *Hit:* `dice:6d6+4|noform|noparens|avg|text(25)` (`6d6 + 4`) Force damage, and the ultroloth can teleport the target up to 10 feet to an unoccupied space the ultroloth can see that isn't in the air.

***Hypnotic Gaze.*** *Wisdom Saving Throw:* DC 17, each creature in a 30-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) Psychic damage, and the target has the [Stunned](3.Mechanics/rules/conditions.md#Stunned) condition until the start of the ultroloth's next turn. *Success:* The target is immune to this ultroloth's Hypnotic Gaze for 24 hours.
...
**At will:** [Alter Self](3.Mechanics/spells/alter-self-xphb.md), [Clairvoyance](3.Mechanics/spells/clairvoyance-xphb.md), [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md)

**1/day each:** [Dimension Door](3.Mechanics/spells/dimension-door-xphb.md), [Fireball](3.Mechanics/spells/fireball-xphb.md) (level 5 version), [Wall of Fire](3.Mechanics/spells/wall-of-fire-xphb.md)

## Bonus Actions

***Fiendish Guile (Recharge 4-6).*** The ultroloth casts [Dispel Magic](3.Mechanics/spells/dispel-magic-xphb.md), [Invisibility](3.Mechanics/spells/invisibility-xphb.md) (self only), [Misty Step](3.Mechanics/spells/misty-step-xphb.md), or [Suggestion](3.Mechanics/spells/suggestion-xphb.md), requiring no Material components and using the same spellcasting ability as Spellcasting.
