...
"actions":
  - "desc": "*Melee  or Ranged Attack Roll:* dice:1d20+2|noform|noparens|text(+2),\
      ...
      \ (1d6) Piercing damage plus dice:1d4|noform|noparens|avg|text(2) (1d4)\
      \ Cold damage. If the target is a creature, its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Merfolk%20Skirmisher.webp"
```
^statblock
