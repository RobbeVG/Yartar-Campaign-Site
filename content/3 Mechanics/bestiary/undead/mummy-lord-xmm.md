...
- "Mummy Lord"
---
# [Mummy Lord](3%20Mechanics/bestiary/undead/mummy-lord-xmm.md)
...
"traits":
  ...
  - "desc": "The mummy has [Advantage](3 Mechanics/rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "If destroyed, the mummy gains a new body in 24 hours if its heart is\
      \ intact, reviving with all its [Hit Points](3 Mechanics/rules/variant-rules/hit-points-xphb.md).\
      \ The new body appears in an unoccupied space within the mummy's lair. The heart\
      \ is a Tiny object that has AC 17, HP 10, and [Immunity](3 Mechanics/rules/variant-rules/immunity-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 15 (2d10 + 4) Bludgeoning\
      ...
      \ While cursed, the target can't regain [Hit Points](3 Mechanics/rules/variant-rules/hit-points-xphb.md),\
      \ it gains no benefit from finishing a [Long Rest](3 Mechanics/rules/variant-rules/long-rest-xphb.md),\
      \ and its [Hit Point](3 Mechanics/rules/variant-rules/hit-points-xphb.md) maximum\
      \ decreases by 10 (3d6) every 24 hours that elapse. A creature dies and turns\
      \ to dust if reduced to 0 [Hit Points](3 Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ by this attack."
    "name": "Rotting Fist"
  ...
  - "desc": "*Wisdom Saving Throw:* DC 17, one creature the mummy can see within 60\
      \ feet. *Failure:* 25 (6d6 + 4) Psychic damage, and the target has the [Paralyzed](3 Mechanics/rules/conditions.md#Paralyzed)\
  ...
  - "desc": "The mummy casts one of the following spells, requiring no Material components\
      ...
      \ with spell attacks):\n\n**At will:** [Dispel Magic](3 Mechanics/spells/dispel-magic-xphb.md),\
      \ [Thaumaturgy](3 Mechanics/spells/thaumaturgy-xphb.md)\n\n**1/day each:** [Animate\
      \ Dead](3 Mechanics/spells/animate-dead-xphb.md), [Harm](3 Mechanics/spells/harm-xphb.md),\
      \ [Insect Plague](3 Mechanics/spells/insect-plague-xphb.md) (level 7 version)"
    "name": "Spellcasting"
"reactions":
  - "desc": "Trigger: The mummy is hit by an attack roll. _Response:_ The mummy adds\
      ...
      \ [Blinded](3 Mechanics/rules/conditions.md#Blinded) condition until the end\
...
"regional_effects":
  - "desc": "The region containing a mummy lord's lair is warped by its presence,\
      ...
      \ Action](3 Mechanics/rules/variant-rules/bonus-action-xphb.md), or [Reaction](3 Mechanics/rules/variant-rules/reaction-xphb.md)\
      \ used to cast the spell is wasted, but any resources used to cast it aren't\
      \ expended.  \n- **Soul Drain.** Creatures within 1 mile of the lair have [Disadvantage](3 Mechanics/rules/variant-rules/disadvantage-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "The mummy casts [Command](3 Mechanics/spells/command-xphb.md) (level\
