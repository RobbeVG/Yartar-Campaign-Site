...
"cr": "10"
"traits":
  - "desc": "The worg has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 15 (2d8 + 6) Piercing damage\
      \ plus 7 (2d6) Poison damage, and the target has the [Poisoned](3.Mechanics/rules/conditions.md#Poisoned)\
      \ condition until the start of the worg's next turn. While [Poisoned](3.Mechanics/rules/conditions.md#Poisoned),\
  ...
  - "desc": "*Wisdom Saving Throw:* DC 16, each creature within 30 feet that isn't\
      \ a worg. *Failure:* 36 (8d8) Psychic damage, and the target has the [Frightened](3.Mechanics/rules/conditions.md#Frightened)\
