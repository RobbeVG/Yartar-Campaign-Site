...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+10|noform|noparens|text(+10), reach\
      ...
      \ no benefit from finishing a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md)."
    "name": "Cursed Touch"
  - "desc": "*Wisdom Saving Throw:* DC 18, each enemy in a 30-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the rakshasa. *Failure:* dice:8d6|noform|noparens|avg|text(28)\
      \ (8d6) Psychic damage, and the target has the [Frightened](3.Mechanics/rules/conditions.md#Frightened)\
      \ and [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) conditions\
  ...
  - "desc": "The rakshasa casts one of the following spells, requiring no Material\
      ...
      \ Thoughts](3.Mechanics/spells/detect-thoughts-xphb.md), [Disguise Self](3.Mechanics/spells/disguise-self-xphb.md),\
      \ [Mage Hand](3.Mechanics/spells/mage-hand-xphb.md), [Minor Illusion](3.Mechanics/spells/minor-illusion-xphb.md)\n\
      \n**1/day each:** [Fly](3.Mechanics/spells/fly-xphb.md), [Invisibility](3.Mechanics/spells/invisibility-xphb.md),\
      \ [Major Image](3.Mechanics/spells/major-image-xphb.md), [Plane Shift](3.Mechanics/spells/plane-shift-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Rakshasa.webp"
```
^statblock
