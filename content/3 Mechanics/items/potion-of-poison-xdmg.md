...
If you drink this potion, you take `dice:4d6|noform|noparens|avg` (`4d6`) Poison damage and must succeed on a DC 13 Constitution saving throw or have the [Poisoned](conditions.md#Poisoned) condition for 1 hour.
