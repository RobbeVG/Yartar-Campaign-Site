...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Guards.webp#right)
...
***Javelin.*** *Melee  or Ranged Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)`, reach 5 ft. or range 30/120 ft. *Hit:* `dice:3d6+4|noform|noparens|avg|text(14)` (`3d6 + 4`) Piercing damage.

***Longsword.*** *Melee Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)`, reach 5 ft. *Hit:* `dice:2d10+4|noform|noparens|avg|text(15)` (`2d10 + 4`) Slashing damage.
```
^statblock
