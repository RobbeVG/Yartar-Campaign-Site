...
***Flyby.*** The owl doesn't provoke [Opportunity Attacks](3.Mechanics/rules/actions.md#Opportunity%20Attack) when it flies out of an enemy's reach.

## Actions

***Talons.*** *Melee Attack Roll:* `dice:1d20+3|noform|noparens|text(+3)`, reach 5 ft. *Hit:* 1 Slashing damage.
```
^statblock
