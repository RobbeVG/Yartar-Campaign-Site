...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Scorpion.webp#right)
...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [Blindsight](3.Mechanics/rules/senses.md#Blindsight) 10 Ft., Passive Perception 9
- **Languages** —
- **Challenge** 0

## Actions

***Sting.*** *Melee Attack Roll:* `dice:1d20+2|noform|noparens|text(+2)`, reach 5 ft. *Hit:* 1 Piercing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) Poison damage.
```
^statblock
