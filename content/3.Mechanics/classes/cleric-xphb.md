...
- **Skill Proficiencies**: *Choose 2:* [History](3.Mechanics/rules/skills.md#History), [Insight](3.Mechanics/rules/skills.md#Insight), [Medicine](3.Mechanics/rules/skills.md#Medicine), [Persuasion](3.Mechanics/rules/skills.md#Persuasion), or [Religion](3.Mechanics/rules/skills.md#Religion)
...
**Starting Equipment:** *Choose A or B:* (A) [Chain Shirt](3.Mechanics/items/chain-shirt-xphb.md), [Shield](3.Mechanics/items/shield-xphb.md), [Mace](3.Mechanics/items/mace-xphb.md), [Holy Symbol](3.Mechanics/items/holy-symbol-xphb.md), [Priest's Pack](3.Mechanics/items/priests-pack-xphb.md), 7 GP; or (B) 110 GP
...
**Cantrips.** You know three cantrips of your choice from the Cleric spell list. [Guidance](3.Mechanics/spells/guidance-xphb.md), [Sacred Flame](3.Mechanics/spells/sacred-flame-xphb.md), and [Thaumaturgy](3.Mechanics/spells/thaumaturgy-xphb.md) are recommended.

Whenever you gain a Cleric level, you can replace one of your cantrips with another cantrip of your choice from the Cleric spell list.

When you reach Cleric levels 4 and 10, you learn another cantrip of your choice from the Cleric spell list, as shown in the Cantrips column of the Cleric Features table.

**Spell Slots.** The Cleric Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Cleric spell list. [Bless](3.Mechanics/spells/bless-xphb.md), [Cure Wounds](3.Mechanics/spells/cure-wounds-xphb.md), [Guiding Bolt](3.Mechanics/spells/guiding-bolt-xphb.md), and [Shield of Faith](3.Mechanics/spells/shield-of-faith-xphb.md) are recommended.
...
**Changing Your Prepared Spells.** Whenever you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells there with other Cleric spells for which you have spell slots.

**Spellcasting Ability.** Wisdom is your spellcasting ability for your Cleric spells.

**Spellcasting Focus.** You can use a [Holy Symbol](3.Mechanics/items/holy-symbol-xphb.md) as a [Spellcasting Focus](3.Mechanics/rules/variant-rules/spellcasting-focus-xphb.md) for your Cleric spells.
...
- **Thaumaturge**  
    You know one extra cantrip from the Cleric spell list. In addition, your mystical connection to the divine gives you a bonus to your Intelligence ([Arcana](3.Mechanics/rules/skills.md#Arcana) or [Religion](3.Mechanics/rules/skills.md#Religion)) checks. The bonus equals your Wisdom modifier (minimum of +1).  

### Channel Divinity (Level 2)

You can channel divine energy directly from the Outer Planes to fuel magical effects. You start with two such effects: Divine Spark and Turn Undead, each of which is described below. Each time you use this class's Channel Divinity, choose which Channel Divinity effect from this class to create. You gain additional effect options at higher Cleric levels.

You can use this class's Channel Divinity twice. You regain one of its expended uses when you finish a [Short Rest](3.Mechanics/rules/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md). You gain additional uses when you reach certain Cleric levels, as shown in the Channel Divinity column of the Cleric Features table.

If a Channel Divinity effect requires a saving throw, the DC equals the spell save DC from this class's Spellcasting feature.

### Divine Spark (Level 2)

As a [Magic](3.Mechanics/rules/actions.md#Magic) action, you point your [Holy Symbol](3.Mechanics/items/holy-symbol-xphb.md) at another creature you can see within 30 feet of yourself and focus divine energy at it. Roll `dice:1d8|noform|noparens|avg` (`1d8`) and add your Wisdom modifier. You either restore [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) to the creature equal to that total or force the creature to make a Constitution saving throw. On a failed save, the creature takes Necrotic or Radiant damage (your choice) equal to that total. On a successful save, the creature takes half as much damage (round down).
...
As a [Magic](3.Mechanics/rules/actions.md#Magic) action, you present your [Holy Symbol](3.Mechanics/items/holy-symbol-xphb.md) and censure Undead creatures. Each Undead of your choice within 30 feet of you must make a Wisdom saving throw. If the creature fails its save, it has the [Frightened](3.Mechanics/rules/conditions.md#Frightened) and [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) conditions for 1 minute. For that duration, it tries to move as far from you as it can on its turns. This effect ends early on the creature if it takes any damage, if you have the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition, or if you die.
...
You gain the [Ability Score Improvement](3.Mechanics/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Cleric levels 8, 12, and 16.
...
You can call on your deity or pantheon to intervene on your behalf. As a [Magic](3.Mechanics/rules/actions.md#Magic) action, choose any Cleric spell of level 5 or lower that doesn't require a [Reaction](3.Mechanics/rules/variant-rules/reaction-xphb.md) to cast. As part of the same action, you cast that spell without expending a spell slot or needing Material components. You can't use this feature again until you finish a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).
...
**Potent Spellcasting.** When you cast a Cleric cantrip and deal damage to a creature with it, you can give vitality to yourself or another creature within 60 feet of yourself, granting a number of [Temporary Hit Points](3.Mechanics/rules/variant-rules/temporary-hit-points-xphb.md) equal to twice your Wisdom modifier.
...
You can call on even more powerful divine intervention. When you use your Divine Intervention feature, you can choose [Wish](3.Mechanics/spells/wish-xphb.md) when you select a spell. If you do so, you can't use Divine Intervention again until you finish `dice:2d4|noform|noparens|avg` (`2d4`) Long Rests.