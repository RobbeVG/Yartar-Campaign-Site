...
```ad-statblock
title: Fiendish Spirit (Devil)
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XPHB/Fiendish%20Spirit%20%28Devil%29.webp#token)
*Large Fiend, Neutral*
...
***Devil's Sight.*** Magical [Darkness](3.Mechanics/rules/variant-rules/darkness-xphb.md) doesn't impede the spirit's Darkvision.
