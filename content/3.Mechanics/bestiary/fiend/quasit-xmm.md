...
"cr": "1"
"traits":
  - "desc": "The quasit has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 10, one creature within 20 feet. *Failure:*\
      \ The target has the [Frightened](3.Mechanics/rules/conditions.md#Frightened)\
    ...
    "name": "Scare (1/Day)"
  - "desc": "The quasit shape-shifts to resemble a bat ([Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
      ...
      \ same in each form, except for its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md).\
      \ Any equipment it is wearing or carrying isn't transformed."
    "name": "Shape-Shift"
  - "desc": "The quasit casts [Invisibility](3.Mechanics/spells/invisibility-xphb.md)\
