...
![Even the bravest souls flee the onslaught of an ancient red dragon](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Ancient%20Red%20Dragon.webp#right)
...
***Multiattack.*** The dragon makes three Rend attacks. It can replace one attack with a use of Spellcasting to cast [Scorching Ray](3.Mechanics/spells/scorching-ray-xphb.md) (level 3 version).

***Rend.*** *Melee Attack Roll:* `dice:1d20+17|noform|noparens|text(+17)`, reach 15 ft. *Hit:* `dice:2d8+10|noform|noparens|avg|text(19)` (`2d8 + 10`) Slashing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) Fire damage.

***Fire Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 24, each creature in a 90-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* `dice:26d6|noform|noparens|avg|text(91)` (`26d6`) Fire damage. *Success:* Half damage.
...
**At will:** [Command](3.Mechanics/spells/command-xphb.md) (level 2 version), [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Scorching Ray](3.Mechanics/spells/scorching-ray-xphb.md) (level 3 version)

**1/day each:** [Fireball](3.Mechanics/spells/fireball-xphb.md) (level 6 version), [Scrying](3.Mechanics/spells/scrying-xphb.md)
...
***Fiery Rays.*** The dragon uses Spellcasting to cast [Scorching Ray](3.Mechanics/spells/scorching-ray-xphb.md) (level 3 version). The dragon can't take this action again until the start of its next turn.
