...
***Rend.*** *Melee Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)`, reach 5 ft. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) Slashing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) Radiant damage.
```
^statblock
