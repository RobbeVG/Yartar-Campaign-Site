...
"traits":
  - "desc": "The vampire takes 10 Radiant damage if it starts its turn in sunlight.\
      \ While in sunlight, it has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](3.Mechanics/rules/variant-rules/dim-light-xphb.md)\
      \ or [Darkness](3.Mechanics/rules/variant-rules/darkness-xphb.md), the vampire\
      \ takes the [Hide](3.Mechanics/rules/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Vampire%20Nightbringer.webp"
```
^statblock
