...
On a failed save, the target has the [Charmed](3.Mechanics/rules/conditions.md#Charmed) condition for the duration. While [Charmed](3.Mechanics/rules/conditions.md#Charmed), the target dances comically, must use all its movement to dance in place, and has [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) on Dexterity saving throws and attack rolls, and other creatures have [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on attack rolls against it. On each of its turns, the target can take an action to collect itself and repeat the save, ending the spell on itself on a success.
