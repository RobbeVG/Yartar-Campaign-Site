...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* dice:1d20+9|noform|noparens|text(+9) to hit,\
      ...
      \ (2d10 + 5) piercing damage plus dice:1d8|noform|noparens|avg|text(4) (1d8)\
      \ force damage."
    "name": "Bite"
  - "desc": "*Melee Weapon Attack:* dice:1d20+9|noform|noparens|text(+9) to hit,\
  ...
  - "desc": "Lowarnizel creates a shining bead of gravitational force, then releases\
      ...
      \ Strength saving throw. On a failed save, a creature takes dice:8d8|noform|noparens|avg|text(36)\
...
"source":
  - "PaBTSO"
"image": "file://bestiary/tokens/PaBTSO/Lowarnizel.webp"
```
^statblock