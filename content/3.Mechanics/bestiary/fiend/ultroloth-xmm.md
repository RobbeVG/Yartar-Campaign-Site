...
"traits":
  ...
  - "desc": "The ultroloth has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 15 ft. *Hit:* 25 (6d6 + 4) Force damage,\
    ...
    "name": "Mercurial Whip"
  - "desc": "*Wisdom Saving Throw:* DC 17, each creature in a 30-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 10 (3d6) Psychic damage, and the target has the [Stunned](3.Mechanics/rules/conditions.md#Stunned)\
  ...
  - "desc": "The ultroloth casts one of the following spells, requiring no Material\
      ...
      \ [Clairvoyance](3.Mechanics/spells/clairvoyance-xphb.md), [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md)\n\
      \n**1/day each:** [Dimension Door](3.Mechanics/spells/dimension-door-xphb.md),\
      \ [Fireball](3.Mechanics/spells/fireball-xphb.md) (level 5 version), [Wall of\
      \ Fire](3.Mechanics/spells/wall-of-fire-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The ultroloth casts [Dispel Magic](3.Mechanics/spells/dispel-magic-xphb.md),\
      \ [Invisibility](3.Mechanics/spells/invisibility-xphb.md) (self only), [Misty\
      \ Step](3.Mechanics/spells/misty-step-xphb.md), or [Suggestion](3.Mechanics/spells/suggestion-xphb.md),\
