...
![When the Rockseeker brothers discovered the mine in Wave Echo Cave, they had no idea such evil forces would want its riches for their own](file://adventure/PaBTSO/047-04-001.ch4-splash.webp#center)
...
The characters should be 4th level when the chapter begins. The characters gain a level when they defeat [Nezznar the Spider](3.Mechanics/bestiary/npc/nezznar-the-spider-pabtso.md).
...
> [!gallery]
> ![Map 4.1: Wave Echo Cave](file://adventure/PaBTSO/048-map-4.01-wave-echo-cave.webp#gallery)
> ![Player Version](file://adventure/PaBTSO/049-map-4.01-wave-echo-cave-player.webp#gallery)
...
![Ochre jellies are always vicious, but especially so when trapped in a dead end in Wave Echo Cave](file://adventure/PaBTSO/050-04-002.ochre-jelly.webp#center)
...
![Mormesk the Wraith](file://adventure/PaBTSO/051-04-003.mormesk-the-wraith.webp#center)
...
![A spectator guards the treasures that lie within the Forge of Spells](file://adventure/PaBTSO/052-04-004.spectator.webp#center)
...
![A showdown with Nezznar the Spider is inevitable](file://adventure/PaBTSO/053-04-005.nezznar-the-spider.webp#center)
...
If the characters capture Nezznar and deliver him to the townmaster's hall in Phandalin, he is locked up until [Sildar Hallwinter](3.Mechanics/bestiary/npc/sildar-hallwinter-pabtso.md) or another representative of the Lords' Alliance can escort him to Neverwinter to face interrogation. The organization in Neverwinter is curious to learn everything Nezznar knows about Wave Echo Cave. Unless the characters post guards outside Nezznar's cell, Halia Thornton (see chapter 2) breaks him out of jail, smuggles him out of Phandalin, and delivers him into the custody of the leaders of the Zhentarim. What happens to Nezznar at that point is up to you.
...
Gundren and [Nundro Rockseeker](3.Mechanics/bestiary/npc/nundro-rockseeker-pabtso.md) take over administration of the new mine. For the adventurers' service to their family, they gladly award the party a 10 percent share of the mine's profits. It's up to you how much gold you give the players and how often. Consider giving the characters a sum of 255 gp (`dice:10d10+200|noform|noparens|avg` (`10d10 + 200`)) at the beginning of each chapter to represent this award.
...
![](file://adventure/PaBTSO/054-04-006.psionic-goblins.webp#center)