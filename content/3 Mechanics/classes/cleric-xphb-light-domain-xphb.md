...
As a [Magic](actions.md#Magic) action, you present your [Holy Symbol](holy-symbol-xphb.md) and expend a use of your Channel Divinity to emit a flash of light in a 30-foot [Emanation](emanation-area-of-effect-xphb.md) originating from yourself. Any magical [Darkness](3%20Mechanics/rules/variant-rules/darkness-xphb.md)—such as that created by the [Darkness](3%20Mechanics/spells/darkness-xphb.md) spell—in that area is dispelled. Additionally, each creature of your choice in that area must make a Constitution saving throw, taking Radiant damage equal to `dice:2d10|noform|noparens|avg` (`2d10`) plus your Cleric level on a failed save or half as much damage on a successful one.
...
In addition, whenever you use Warding Flare, you can give the target of the triggering attack a number of [Temporary Hit Points](temporary-hit-points-xphb.md) equal to `dice:2d6|noform|noparens|avg` (`2d6`) plus your Wisdom modifier.
