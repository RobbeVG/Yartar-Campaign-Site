...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Slashing damage."
    "name": "Claw"
  - "desc": "*Dexterity Saving Throw:* DC 10, each creature in a 15-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target has the [Blinded](3.Mechanics/rules/conditions.md#Blinded)\
      \ condition until the end of the mephit's next turn."
    "name": "Blinding Breath (Recharge 6)"
  - "desc": "The mephit casts the [Sleep](3.Mechanics/spells/sleep-xphb.md) spell,\
