...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 17, one creature the devil can see within\
      ...
      \ (3d6) [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) at\
      \ the start of each of its turns. The wound closes after 1 minute, after a spell\
      \ restores [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Horned%20Devil.webp"
```
^statblock
