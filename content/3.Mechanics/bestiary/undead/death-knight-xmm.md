...
"traits":
  ...
  - "desc": "If the death knight is destroyed before it atones for its evil, it gains\
      \ a new body in 1d10 days, reviving with all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md).\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the death knight can\
      ...
      \ [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md) maximum decreases\
