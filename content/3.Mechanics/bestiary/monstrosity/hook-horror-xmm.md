...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Hook%20Horror.webp#right)
...
***Hook.*** *Melee Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)`, reach 10 ft. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) Piercing damage. If the target is a Large or smaller creature, the hook horror moves the target 5 feet straight toward or away from itself.
```
^statblock
