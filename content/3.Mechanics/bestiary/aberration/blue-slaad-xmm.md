...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
      ...
      \ *Failure:* The target is cursed. The cursed target can't regain [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md),\
      ...
      \ finishing a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).\
