...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* dice:1d20+8|noform|noparens|text(+8), reach 10\
      ...
      \ damage plus dice:1d6|noform|noparens|avg|text(3) (1d6) Poison damage.\
      \ If the target is a Humanoid not cursed by a slaad, it is subjected to the\
      \ following effect. *Constitution Saving Throw:* DC 15. *Failure:* The target\
      \ is cursed. The cursed target can't regain [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md),\
      \ and its [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md) maximum\
      \ decreases by dice:3d6|noform|noparens|avg|text(10) (3d6) after every 24\
      \ hours and doesn't return to normal after finishing a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md).\
      \ If the curse reduces the target's [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ maximum to 0, the curse ends, and instead of dying, the target instantly transforms\
      \ into a [Red Slaad](3.Mechanics/bestiary/aberration/red-slaad-xmm.md) or, if\
      \ it can cast spells of level 3 or higher, a [Green Slaad](3.Mechanics/bestiary/aberration/green-slaad-xmm.md).\
      \ Only a [Wish](3.Mechanics/spells/wish-xphb.md) spell can reverse this transformation."
    "name": "Mutating Claw"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Blue%20Slaad.webp"
```
^statblock
