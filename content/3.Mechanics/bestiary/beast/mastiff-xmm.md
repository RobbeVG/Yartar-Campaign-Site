...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Mastiff.webp#right)
...
***Bite.*** *Melee Attack Roll:* `dice:1d20+3|noform|noparens|text(+3)`, reach 5 ft. *Hit:* `dice:1d6+1|noform|noparens|avg|text(4)` (`1d6 + 1`) Piercing damage. If the target is a Medium or smaller creature, it has the [Prone](3.Mechanics/rules/conditions.md#Prone) condition.
```
^statblock
