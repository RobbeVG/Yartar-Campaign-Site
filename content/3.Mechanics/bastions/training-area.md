...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](3.Mechanics/rules/variant-rules/unarmed-strike-xphb.md) or a weapon, you can take a [Reaction](3.Mechanics/rules/variant-rules/reaction-xphb.md) to reduce this damage by `dice:1d4\|noform\|noparens\|avg` (`1d4`). |
| Skills Expert | You gain proficiency in one of the following skills of your choice: [Acrobatics](3.Mechanics/rules/skills.md#Acrobatics), [Athletics](3.Mechanics/rules/skills.md#Athletics), [Performance](3.Mechanics/rules/skills.md#Performance), [Sleight of Hand](3.Mechanics/rules/skills.md#Sleight%20of%20Hand), or [Stealth](3.Mechanics/rules/skills.md#Stealth). |
| Tools Expert | You gain proficiency with one tool of your choice. |
| Unarmed Combat Expert | When you hit with your [Unarmed Strike](3.Mechanics/rules/variant-rules/unarmed-strike-xphb.md) and deal damage, the attack deals an extra `dice:1d4\|noform\|noparens\|avg` (`1d4`) Bludgeoning damage. |
| Weapon Expert | Choose a kind of Simple or Martial weapon, such as [Spear](3.Mechanics/items/spear-xphb.md) or [Longbow](3.Mechanics/items/longbow-xphb.md). If you aren't proficient with the weapon, you gain proficiency with it. If you already have proficiency with the weapon, you can use its mastery property. |
^expert-trainers
