...
"actions":
  ...
  - "desc": "*Intelligence Saving Throw:* DC 12, one creature the intellect devourer\
      ...
      \ (2d10) Psychic damage, and the target has the [Stunned](3.Mechanics/rules/conditions.md#Stunned)\
  ...
  - "desc": "*Intelligence Saving Throw:* DC 12, one Small or Medium creature within\
      \ 5 feet that has the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated)\
      \ condition, is a Humanoid or Beast, and has 10 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ brain by means of a [Wish](3.Mechanics/spells/wish-xphb.md) spell. By spending\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Intellect%20Devourer.webp"
```
^statblock
