...
![Luck Blade (Shortsword)](file://items/XDMG/Luck%20Blade.webp#right)
...
If the weapon is on your person, you can call on its luck (no action required) to reroll one failed [D20 Test](3.Mechanics/rules/variant-rules/d20-test-xphb.md) if you don't have the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition. You must use the second roll. Once used, this property can't be used again until the next dawn.

## Wish

The weapon has `dice:1d3|noform|noparens|avg` (`1d3`) charges. While holding it, you can expend 1 charge and cast [Wish](3.Mechanics/spells/wish-xphb.md) from it. Once used, this property can't be used again until the next dawn. The weapon loses this property if it has no charges.
