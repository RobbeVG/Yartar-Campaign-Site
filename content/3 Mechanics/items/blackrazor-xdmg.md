...
You gain a +3 bonus to attack rolls and damage rolls made with this magic weapon. If you hit an Undead with this weapon, you take `dice:1d10|noform|noparens|avg` (`1d10`) Necrotic damage, and the target regains `dice:1d10|noform|noparens|avg` (`1d10`) [Hit Points](hit-points-xphb.md). If this Necrotic damage reduces you to 0 [Hit Points](hit-points-xphb.md), Blackrazor devours your soul (see "Devour Soul" below).
