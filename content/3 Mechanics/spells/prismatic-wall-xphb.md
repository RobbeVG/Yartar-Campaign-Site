...
| 2 | **Orange.** *Failed Save:* `dice:12d6\|noform\|noparens\|avg` (`12d6`) Acid damage. *Successful Save:* Half as much damage. *Additional Effects:* Magical ranged attacks can't pass through this layer, which is destroyed by a strong wind (such as the one created by [Gust of Wind](gust-of-wind-xphb.md)). |
...
| 4 | **Green.** *Failed Save:* `dice:12d6\|noform\|noparens\|avg` (`12d6`) Poison damage. *Successful Save:* Half as much damage. *Additional Effects:* A [Passwall](passwall-xphb.md) spell, or another spell of equal or greater level that can open a portal on a solid surface, destroys this layer. |
...
**Classes**: [Bard](list-spells-classes-bard.md); [Wizard (Abjurer)](list-spells-classes-abjurer-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
