...
> 
> If you can't find a rule, check the index. If a rule's name has changed from what was printed in the 2014 *Player's Handbook*, the index points you to the new name. For example, if you look up Inspiration in the index, it points you to the rules for [Heroic Inspiration](3.Mechanics/rules/variant-rules/heroic-inspiration-xphb.md) in the rules glossary.
