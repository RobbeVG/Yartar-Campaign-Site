...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Ape.webp#right)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](3.Mechanics/rules/skills.md#Athletics) +5, [Perception](3.Mechanics/rules/skills.md#Perception) +3
...
***Fist.*** *Melee Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)`, reach 5 ft. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) Bludgeoning damage.

***Rock (Recharge 6).*** *Ranged Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)`, range 25/50 ft. *Hit:* `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) Bludgeoning damage.
```
^statblock
