...
"actions":
  - "desc": "*Melee Attack Roll:* +5 (with [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
      \ if the target doesn't have all its [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)),\
...
"source":
  - "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Swarm%20of%20Piranhas.webp"
```
^statblock
