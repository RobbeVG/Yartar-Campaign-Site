...
- **Craft.** Holy Water. You commission the facility's hireling to craft a flask of [Holy Water](holy-water-xphb.md). The work takes 7 days and costs no money. You can spend GP during the creation process to increase the potency of the Holy Water. For every 100 GP you spend, up to a maximum of 500 GP, the damage dealt by the Holy Water increases by `dice:1d8|noform|noparens|avg` (`1d8`).  
