...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
      ...
      \ While cursed, the target gains no benefit from finishing a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md)\
  ...
  - "desc": "*Wisdom Saving Throw:* DC 18, each enemy in a 30-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      ...
      \ target has the [Frightened](3.Mechanics/rules/conditions.md#Frightened) and\
      \ [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) conditions\
