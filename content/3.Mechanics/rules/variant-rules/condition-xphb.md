...
A condition doesn't stack with itself; a recipient either has a condition or doesn't. The [Exhaustion](3.Mechanics/rules/conditions.md#Exhaustion) condition is an exception to that rule.