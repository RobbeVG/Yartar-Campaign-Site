...
| dice: 1d100 | Result |
|-------------|--------|
| 01 | Both potions lose their effects, and the mixture creates a magical explosion in a 5-foot-radius [Sphere](sphere-area-of-effect-xphb.md) centered on itself. Each creature in that area takes `dice:4d10\|noform\|noparens\|avg` (`4d10`) Force damage. |
