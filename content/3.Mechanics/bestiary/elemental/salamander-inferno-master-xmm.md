...
"traits":
  - "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
      \ choice in a 10-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the salamander takes dice:3d6|noform|noparens|avg|text(10)\
      \ (3d6) Fire damage."
    "name": "Fire Aura"
  - "desc": "The salamander has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* dice:1d20+12|noform|noparens|text(+12),\
    ...
    "name": "Flame Trident"
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 30-foot-radius [Sphere](3.Mechanics/rules/variant-rules/sphere-area-of-effect-xphb.md)\
      \ centered on a point the salamander can see within 120 feet. *Failure:* dice:10d6|noform|noparens|avg|text(35)\
      \ (10d6) Fire damage, and the target starts [burning](3.Mechanics/traps-hazards/burning-xphb.md),\
      \ taking dice:1d10|noform|noparens|avg|text(5) (1d10) Fire damage at the\
      \ start of each of its turns instead of the normal [burning](3.Mechanics/traps-hazards/burning-xphb.md)\
      \ damage. The target gains 1 [Exhaustion](3.Mechanics/rules/conditions.md#Exhaustion)\
      \ level whenever it takes this [burning](3.Mechanics/traps-hazards/burning-xphb.md)\
      \ damage. *Success:* Half damage only."
    "name": "Inferno Blast (Recharge 5-6)"
"bonus_actions":
  - "desc": "The salamander moves up to its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
      \ without provoking [Opportunity Attacks](3.Mechanics/rules/actions.md#Opportunity%20Attack).\
      \ During this movement, fire fills a 5-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the salamander. When the [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Salamander%20Inferno%20Master.webp"
```
^statblock
