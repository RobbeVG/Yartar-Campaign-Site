...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/XMM/Giant%20Goat.webp#right)
...
***Ram.*** *Melee Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)`, reach 5 ft. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) Bludgeoning damage. If the target is a Large or smaller creature and the goat moved 20+ feet straight toward it immediately before the hit, the target takes an extra `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) Bludgeoning damage and has the [Prone](3.Mechanics/rules/conditions.md#Prone) condition.
```
^statblock
