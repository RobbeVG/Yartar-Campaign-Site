...
- "Arch-hag"
---
# [Arch-hag](3%20Mechanics/bestiary/fey/arch-hag-xmm.md)
...
"traits":
  ...
  - "desc": "When the hag drops to 0 [Hit Points](3 Mechanics/rules/variant-rules/hit-points-xphb.md),\
      ...
      \ of the space it left is cursed. Until the curse ends, a creature has [Disadvantage](3 Mechanics/rules/variant-rules/disadvantage-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an arch-hag's lair is altered by its presence,\
      ...
      \ check they make when they take the [Influence](3 Mechanics/rules/actions.md#Influence)\
