...
"actions":
  - "desc": "*Melee Attack Roll:* dice:1d20+11|noform|noparens|text(+11), reach\
      ...
      \ condition (escape DC 17), and it has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
...
"bonus_actions":
  - "desc": "*Strength Saving Throw:* DC 19, one Large or smaller creature [Grappled](3.Mechanics/rules/conditions.md#Grappled)\
      ...
      \ The target is swallowed by the remorhaz, and the [Grappled](3.Mechanics/rules/conditions.md#Grappled)\
      \ condition ends. A swallowed creature has the [Blinded](3.Mechanics/rules/conditions.md#Blinded)\
      \ and [Restrained](3.Mechanics/rules/conditions.md#Restrained) conditions, it\
      \ has [Total Cover](3.Mechanics/rules/variant-rules/cover-xphb.md) against attacks\
      \ and other effects outside the remorhaz, and it takes dice:3d6|noform|noparens|avg|text(10)\
      ...
      \ 5 feet of the remorhaz and has the [Prone](3.Mechanics/rules/conditions.md#Prone)\
      ...
      \ escape from the corpse by using 15 feet of movement, exiting [Prone](3.Mechanics/rules/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Remorhaz.webp"
```
^statblock
