...
When you hit a Giant with this weapon, the Giant takes an extra `dice:2d6|noform|noparens|avg` (`2d6`) damage of the weapon's type and must succeed on a DC 15 Strength saving throw or have the [Prone](3.Mechanics/rules/conditions.md#Prone) condition.
