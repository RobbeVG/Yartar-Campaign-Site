...
"traits":
  - "desc": "While within 30 feet of at least two hag allies, the hag can cast one\
      ...
      \ save DC 14): [Augury](3.Mechanics/spells/augury-xphb.md), [Find Familiar](3.Mechanics/spells/find-familiar-xphb.md),\
  ...
  - "desc": "The hag has a soul bag. While holding or carrying the bag, the hag can\
      \ use its Nightmare Haunting action.\n\nThe bag has AC 15, HP 20, and [Resistance](3.Mechanics/rules/variant-rules/resistance-xphb.md)\
      \ to all damage. The bag turns to dust if reduced to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "The hag casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Detect Magic](3.Mechanics/spells/detect-magic-xphb.md), [Etherealness](3.Mechanics/spells/etherealness-xphb.md),\
      \ [Magic Missile](3.Mechanics/spells/magic-missile-xphb.md) (level 4 version)\n\
      \n**2/day each:** [Phantasmal Killer](3.Mechanics/spells/phantasmal-killer-xphb.md),\
      \ [Plane Shift](3.Mechanics/spells/plane-shift-xphb.md) (self only)"
    "name": "Spellcasting"
  - "desc": "While on the Ethereal Plane, the hag casts [Dream](3.Mechanics/spells/dream-xphb.md),\
      ...
      \ the effect of the [Protection from Evil and Good](3.Mechanics/spells/protection-from-evil-and-good-xphb.md)\
      \ spell or within a [Magic Circle](3.Mechanics/spells/magic-circle-xphb.md)\
      \ spell.\n\nIf the target takes damage from the [Dream](3.Mechanics/spells/dream-xphb.md)\
      \ spell, the target's [Hit Point](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
