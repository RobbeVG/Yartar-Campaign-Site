...
FROM "3 Mechanics/bestiary/construct"
WHERE !draft AND file != this.file
-->
<!-- SerializedQuery: LIST WITHOUT ID link(file.link, title) FROM "3 Mechanics/bestiary/construct" WHERE !draft AND file != this.file -->
