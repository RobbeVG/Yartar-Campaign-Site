...
A storm cloud appears at a point within range that you can see above yourself. It takes the shape of a [Cylinder](3.Mechanics/rules/variant-rules/cylinder-area-of-effect-xphb.md) that is 10 feet tall with a 60-foot radius.
...
Until the spell ends, you can take a [Magic](3.Mechanics/rules/actions.md#Magic) action to call down lightning in that way again, targeting the same point or a different one.
...
**Classes**: [Bard (College of Lore)](3.Mechanics/lists/list-spells-classes-college-of-lore-xphb.md "subclass=XPHB;class=XPHB"); [Bard](3.Mechanics/lists/list-spells-classes-bard.md); [Druid](3.Mechanics/lists/list-spells-classes-druid.md)
