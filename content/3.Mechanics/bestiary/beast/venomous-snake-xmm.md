...
***Bite.*** *Melee Attack Roll:* `dice:1d20+4|noform|noparens|text(+4)`, reach 5 ft. *Hit:* `dice:1d4+2|noform|noparens|avg|text(4)` (`1d4 + 2`) Piercing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) Poison damage.
```
^statblock
