...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Mind Spike](3.Mechanics/spells/mind-spike-xphb.md)\
      \ (level 3 version)."
    "name": "Multiattack"
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, each creature in a 60-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* dice:16d6|noform|noparens|avg|text(56) (16d6) Poison damage.\
      \ *Success:* Half damage."
...
"regional_effects":
  - "desc": "The region containing an adult or ancient green dragon's lair is warped\
      ...
      \ a [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md) in that area,\
      \ it must succeed on a DC 15 Constitution saving throw or have the [Poisoned](3.Mechanics/rules/conditions.md#Poisoned)\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 17, each creature in a 20-foot-radius\
      ...
      \ on a point the dragon can see within 90 feet. *Failure:* dice:2d6|noform|noparens|avg|text(7)\
...
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Adult%20Green%20Dragon.webp"
```
^statblock
