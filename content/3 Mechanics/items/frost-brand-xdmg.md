...
When you hit with an attack roll using this magic weapon, the target takes an extra `dice:1d6|noform|noparens|avg` (`1d6`) Cold damage. In addition, while you hold the weapon, you have [Resistance](3%20Mechanics/rules/variant-rules/resistance-xphb.md) to Fire damage.
