...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Bludgeoning damage,\
      ...
      \ creature and the darkmantle had [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
      \ on the attack roll, it covers the target, which has the [Blinded](3.Mechanics/rules/conditions.md#Blinded)\
      ...
      \ has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on its\
      \ attack rolls. Its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md) becomes\
      \ 0, it can't benefit from any bonus to its [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md),\
      \ and it moves with the target.\n\nA creature can take an action to try to detach\
      \ the darkmantle from itself, doing so with a successful DC 13 Strength ([Athletics](3.Mechanics/rules/skills.md#Athletics))\
  ...
  - "desc": "Magical [Darkness](3.Mechanics/rules/variant-rules/darkness-xphb.md)\
      \ fills a 15-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the darkmantle. This effect lasts while the darkmantle maintains\
      \ [Concentration](3.Mechanics/rules/conditions.md#Concentration) on it, up to\
