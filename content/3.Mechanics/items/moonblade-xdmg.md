...
Every Moonblade longs for a bearer whose disposition and goals are compatible with its own. If you try to attune to a Moonblade that doesn't want you as its bearer, the weapon not only rejects you but also places a curse on you, causing you to make [D20 Tests](3.Mechanics/rules/variant-rules/d20-test-xphb.md) with [Disadvantage](3.Mechanics/rules/variant-rules/disadvantage-xphb.md) for 24 hours or until the curse is ended by a [Remove Curse](3.Mechanics/spells/remove-curse-xphb.md) spell or similar magic. If you're accepted by the weapon and try to attune to it, you become attuned to it instantly, and a new rune appears on it. You remain attuned to the weapon until you die or the weapon is destroyed. A Moonblade functions like a nonmagical weapon of its kind for anyone other than its chosen bearer.
...
A Moonblade is a sentient weapon with an Intelligence of 12, a Wisdom of 10, and a Charisma of 12. It has hearing and [Darkvision](3.Mechanics/rules/senses.md#Darkvision) out to 120 feet. Its alignment matches that of its creator.
...
| 76-80 | The *Moonblade* gains [Thrown](3.Mechanics/rules/item-properties.md#Thrown) with a normal range of 20 feet and a long range of 60 feet. Each time you throw the weapon, it flies back to your hand after the attack. |
| 81-85 | The *Moonblade* scores a [Critical Hit](3.Mechanics/rules/variant-rules/critical-hit-xphb.md) on a roll of 19 or 20 on the `dice:d20\|noform\|noparens\|avg` (`d20`). |
| 86-95 | You can take a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md) to cause the *Moonblade* to flash brightly. Each other creature that is within 30 feet of you and not behind [Total Cover](3.Mechanics/rules/variant-rules/cover-xphb.md) must succeed on a DC 15 Constitution saving throw or have the [Blinded](3.Mechanics/rules/conditions.md#Blinded) condition for 1 minute. A creature repeats the save at the end of each of its turns, ending the effect on itself on a success. You can't use this property again until you finish a [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md). |
| 96-99 | The Moonblade has the properties of a [Ring of Spell Storing](3.Mechanics/items/ring-of-spell-storing-xdmg.md). |
| 100 | You can take a [Magic](3.Mechanics/rules/actions.md#Magic) action to conjure a spectral entity that resembles a shadowy elf if you don't already have one serving you. The entity appears in an unoccupied space within 120 feet of you. It uses the [Shadow](3.Mechanics/bestiary/undead/shadow-xmm.md) stat block with these changes: it is a Fey, has a Neutral alignment, and doesn't create new shadows. You control this entity, deciding how it acts and moves. It remains until it drops to 0 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) or you dismiss it as a [Magic](3.Mechanics/rules/actions.md#Magic) action. |
^moonblade-properties
