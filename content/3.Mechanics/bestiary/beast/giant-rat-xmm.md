...
***Pack Tactics.*** The rat has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md) on an attack roll against a creature if at least one of the rat's allies is within 5 feet of the creature and the ally doesn't have the [Incapacitated](3.Mechanics/rules/conditions.md#Incapacitated) condition.

## Actions

***Bite.*** *Melee Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)`, reach 5 feet. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) Piercing damage.
```
^statblock
