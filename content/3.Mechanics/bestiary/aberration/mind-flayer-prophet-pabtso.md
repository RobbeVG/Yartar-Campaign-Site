...
"actions":
  - "desc": "*Melee Weapon Attack:* dice:1d20+8|noform|noparens|text(+8) to hit,\
    ...
    "name": "Tentacles"
  - "desc": "*Melee Weapon Attack:* dice:1d20+8|noform|noparens|text(+8) to hit,\
      \ reach 5 ft., one Humanoid [grappled](3.Mechanics/rules/conditions.md#Grappled)\
      \ by the mind flayer. *Hit:* dice:10d10|noform|noparens|avg|text(55) (10d10)\
      \ piercing damage. If this damage reduces the target to 0 hit points, the mind\
      \ flayer kills it by extracting and devouring its brain."
    "name": "Extract Brain"
  - "desc": "The mind flayer lashes out with psychic energy, targeting up to two creatures\
      ...
      \ saving throw or take dice:4d8+5|noform|noparens|avg|text(23) (4d8 + 5)\
      \ psychic damage and have the [stunned](3.Mechanics/rules/conditions.md#Stunned)\
...
"source":
  - "PaBTSO"
"image": "file://bestiary/tokens/PaBTSO/Mind%20Flayer%20Prophet.webp"
```
^statblock