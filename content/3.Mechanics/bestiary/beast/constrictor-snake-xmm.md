...
***Bite.*** *Melee Attack Roll:* `dice:1d20+4|noform|noparens|text(+4)`, reach 5 ft. *Hit:* `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) Piercing damage.

***Constrict.*** *Strength Saving Throw:* DC 12, one Medium or smaller creature the snake can see within 5 feet. *Failure:* `dice:3d4|noform|noparens|avg|text(7)` (`3d4`) Bludgeoning damage, and the target has the [Grappled](3.Mechanics/rules/conditions.md#Grappled) condition (escape DC 12).
```
^statblock
