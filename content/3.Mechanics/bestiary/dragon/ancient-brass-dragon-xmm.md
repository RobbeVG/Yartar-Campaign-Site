...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 21, each creature in a 90-foot [Cone](3.Mechanics/rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Scorching Ray](3.Mechanics/spells/scorching-ray-xphb.md) (level 3 version),\
...
"legendary_actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 20, one creature the dragon can see within\
      \ 120 feet. *Failure:* 36 (8d8) Fire damage, and the target's [Speed](3.Mechanics/rules/variant-rules/speed-xphb.md)\
