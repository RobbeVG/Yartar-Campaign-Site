...
"actions":
  - "desc": "*Melee Weapon Attack:* dice:1d20+9|noform|noparens|text(+9) to hit,\
      ...
      \ fire damage. If the auger moves at least 20 feet in a straight line toward\
      \ the target immediately before the hit, the target takes an additional dice:2d10|noform|noparens|avg|text(11)\
      \ (2d10) piercing damage, and if the target is a creature, it must succeed\
      \ on a DC 17 Strength saving throw or have the [prone](3.Mechanics/rules/conditions.md#Prone)\
      \ condition."
    "name": "Flaming Drill"
"bonus_actions":
  - "desc": "The auger releases an intense burst of heat in a 30-foot-radius sphere\
      ...
      \ area must make a DC 17 Constitution saving throw, taking dice:3d8|noform|noparens|avg|text(13)\
      \ (3d8) fire damage on a failed save, or half as much damage on a successful\
      \ one."
    "name": "Burst of Heat (Recharge 5-6)"
"source":
  - "PaBTSO"
"image": "file://bestiary/tokens/PaBTSO/Fiendish%20Auger.webp"
```
^statblock