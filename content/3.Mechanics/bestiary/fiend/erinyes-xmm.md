...
"traits":
  ...
  - "desc": "The erinyes has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The erinyes has a magic rope. While bearing it, the erinyes can use the\
      \ Entangling Rope action. The rope has AC 20, HP 90, and [Immunity](3.Mechanics/rules/variant-rules/immunity-xphb.md)\
      \ to Poison and Psychic damage. The rope turns to dust if reduced to 0 [Hit\
      \ Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md), if it is 5+ feet\
      ...
      \ [Short](3.Mechanics/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3.Mechanics/rules/variant-rules/long-rest-xphb.md)."
    "name": "Magic Rope"
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 16, one creature the erinyes can see within\
      \ 120 feet. *Failure:* 14 (4d6) Force damage, and the target has the [Restrained](3.Mechanics/rules/conditions.md#Restrained)\
      \ condition until the rope is destroyed, the erinyes uses a [Bonus Action](3.Mechanics/rules/variant-rules/bonus-action-xphb.md)\
