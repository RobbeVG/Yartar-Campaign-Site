...
"traits":
  ...
  - "desc": "The solar has [Advantage](3.Mechanics/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 21, one creature the solar can see within\
      \ 600 feet. *Failure:* If the creature has 100 [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md)\
      \ or fewer, it dies. It otherwise takes dice:4d8+6|noform|noparens|avg|text(24)\
      \ (4d8 + 6) Piercing damage plus dice:8d8|noform|noparens|avg|text(36) (8d8)\
      \ Radiant damage."
    "name": "Slaying Bow"
  - "desc": "The solar casts one of the following spells, requiring no Material components\
      ...
      \ [Dispel Evil and Good](3.Mechanics/spells/dispel-evil-and-good-xphb.md), [Resurrection](3.Mechanics/spells/resurrection-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The solar casts [Cure Wounds](3.Mechanics/spells/cure-wounds-xphb.md)\
      \ (level 2 version), [Lesser Restoration](3.Mechanics/spells/lesser-restoration-xphb.md),\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 25, one creature the solar can see within\
      \ 120 feet. *Failure:* The target has the [Blinded](3.Mechanics/rules/conditions.md#Blinded)\
  ...
  - "desc": "The solar teleports up to 60 feet to an unoccupied space it can see.\
      \ *Dexterity Saving Throw:* DC 25, each creature in a 10-foot [Emanation](3.Mechanics/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the solar at its destination space. *Failure:* dice:2d10|noform|noparens|avg|text(11)\
      \ (2d10) Radiant damage. *Success:* Half damage."
    "name": "Radiant Teleport"
"source":
  - "XMM"
"image": "file://bestiary/tokens/XMM/Solar.webp"
```
^statblock
