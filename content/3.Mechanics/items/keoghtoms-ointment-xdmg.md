...
As a [Utilize](3.Mechanics/rules/actions.md#Utilize) action, you can swallow one dose of the ointment or apply it to a creature within 5 feet of yourself. The creature that receives it regains `dice:2d8+2|noform|noparens|avg` (`2d8 + 2`) [Hit Points](3.Mechanics/rules/variant-rules/hit-points-xphb.md) and ceases to have the [Poisoned](3.Mechanics/rules/conditions.md#Poisoned) condition.
